...
# ── PARAMS_BLOCK_START ──
VARIANT_ID = 'split_size_v1'
VARIANT_LABEL = 'Step 2: split base_size → quote_size + take_size (equal at 20/15)'
...
def trade_flow_mm(state: TradingState, ts: dict, product: str, p: dict) -> List[Order]:
    ...
    take_size = p["alpha_take_size"] if is_strong else take_size_default
    ...
    if abs(pos_gap) >= p["pos_gap_threshold"]:
        ...
        b_size_target = a_size_target = quote_size_default
...
# nonce: 2026-04-26T17:53:17.988706 386228351