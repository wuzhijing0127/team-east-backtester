...
# ── PARAMS_BLOCK_START ──
VARIANT_ID = 'target_pos_v1'
VARIANT_LABEL = 'Step 4: compute target_pos from alpha_raw (HG: scale=25, cap=120; VFE: scale=20, cap=100). Behavior gated off.'
...
# nonce: 2026-04-26T17:56:36.625839 453104088