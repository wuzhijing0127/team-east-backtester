...
# === MAF_HOOK ===
MAF = 0   # v2+: MAF confirmed useless in round 3 (see maf batch results)
# ================

ASH_LIMIT = 10   # v2 ablation: smaller than v1's 20
ASH_INIT_FAIR = 10000
ASH_EMA_ALPHA = 0.01
ASH_HALF_SPREAD = 1
ASH_K_INV = 2.5
ASH_BASE_SIZE = 4   # scaled down with smaller limit
ASH_TAKE_EDGE = 1
