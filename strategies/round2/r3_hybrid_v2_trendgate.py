...
# Trend gate parameters (fast/slow EMAs for regime detection)
PEPPER_TREND_FAST_ALPHA = 2 / 15    # ~14-tick
PEPPER_TREND_SLOW_ALPHA = 2 / 61    # ~60-tick
TREND_UP_CONFIRM   = 1.5       # fast - slow above this → uptrend
TREND_DOWN_CONFIRM = -1.5      # fast - slow below this → downtrend
TREND_CONFIRM_TICKS = 5        # must hold for this many consecutive ticks

# Position targets by regime
PEPPER_UPTREND_TARGET = 80     # max long when confirmed uptrend
PEPPER_NEUTRAL_TARGET = 40     # half exposure when unclear (50% of limit)
PEPPER_DOWNTREND_TARGET = 0    # flatten when confirmed downtrend
