...
ASH_PARAMS = {
    ...
    # Multi-level quoting
    "L1_size": 25,              # v4.1: heavier concentration at tight layer
    "L2_spread": 4,
    "L2_size": 2,
    "L3_spread": 8,
    "L3_size": 0,               # v4.1: drop wide backstop — freed size goes to L1
}
...
PEPPER_PARAMS = {
    ...
    "take_profit_edge": 3,        # v4.1: slightly tighter take-profit
