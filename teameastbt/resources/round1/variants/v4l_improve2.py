# v4l_improve2 — v4e with improve-by-2 for ASH when spread ≥ 12
"""
...
ASH_PARAMS = {
    ...
    "take_edge_buy": 2,         # v4e: aggressive takes
    "take_edge_sell": 3,        # v4e: aggressive takes
    "k_inv": 2.5,
    "flatten_size": 10,
    "tier_medium": 0.4,
    "tier_high": 0.7,
    ...
    "narrow_spread_thr": 4,     # v4e: improve-by-1 mode
    "very_wide_spread_thr": 12, # v4l: improve by 2 when spread >= this
    # Multi-level quoting
    "L1_size": 8,               # v4e: tight quote
...
PEPPER_PARAMS = {
    ...
    "dip_threshold": 3,           # v4e: earlier dip boost
    "take_profit_edge": 4,        # sell when bid > fair + this
    "min_long_frac": 0.96,        # v4e: core = 48
    # Passive quoting
    "bid_spread": 4,
    "ask_spread": 8,
    "base_size": 10,
...
def spread_adaptive_quote(
    ...
    if mkt_spread <= narrow_thr:
        ...
        bid_price = best_bid
        ask_price = best_ask
    elif mkt_spread >= very_wide_thr:
        # v4l: very wide — queue-jump by 2
        bid_price = best_bid + 2
...
def trade_ash(state: TradingState, ts: dict) -> List[Order]:
    ...
    if best_bid is not None and best_ask is not None:
        ...
        l1_bid, l1_ask = spread_adaptive_quote(
            ...
            bias=inv_bias,
            very_wide_thr=p["very_wide_spread_thr"],
        )
        if l1_buy > 0:
