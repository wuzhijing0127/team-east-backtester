# v4r2 — quote-only skew, widened + more sensitive per user spec
# alpha=0.15, noise_gate=2.0, overlay_conf_min=0.20, spread_gate=3, skew 0.20..1.00
"""
...
def trade_ash(state: TradingState, ts: dict) -> List[Order]:
    ...
    if best_bid is not None and best_ask is not None:
        ...
        # v4r2: graded signal, don't-trade zones, base+overlay separation
        ...
        # Overlay cross DISABLED in this variant
