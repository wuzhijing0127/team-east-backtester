# v4r_graded_quote_only — same signal as v4q but no cross-spread take (size-skew only)
"""
...
def trade_ash(state: TradingState, ts: dict) -> List[Order]:
    ...
    if best_bid is not None and best_ask is not None:
        ...
        # --- Overlay DISABLED in v4r: test size-skew-only ---
        if False:  # v4r: no cross-spread overlay
            pass
        # --- Overlay (disabled): cross the spread ONLY when signal is strong (>=0.75) ---
