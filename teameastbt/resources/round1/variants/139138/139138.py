# v4d_pepper_max
# Hypothesis: PEPPER is held at 40 core; lifting to 48 core and buying dips 1 tick more aggressively captures more drift.
"""
...
PEPPER_PARAMS = {
    ...
    "buy_edge": 1,                # v4d: pay 1 tick above fair normally
    "dip_buy_edge": 3,            # v4: when dev < -dip_threshold, buy up to fair+3
    "dip_threshold": 3,           # v4d: trigger dip boost sooner
    "take_profit_edge": 4,        # sell when bid > fair + this
    "min_long_frac": 0.96,        # v4d: core position = 48 units always long
    # Passive quoting
    "bid_spread": 4,
    "ask_spread": 8,
    "base_size": 10,
