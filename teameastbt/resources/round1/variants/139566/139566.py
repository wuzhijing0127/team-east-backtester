# v4f_tighter
# Push v4b axis: L1_size 5. If ASH grows further, tightness wins. If it shrinks, we overshot.
"""
...
ASH_PARAMS = {
    ...
    "narrow_spread_thr": 4,     # v4f: improve by 1
    # Multi-level quoting
    "L1_size": 5,               # v4f: even smaller than v4b
    "L2_spread": 4,             # v3: slightly closer mid layer
    "L2_size": 5,               # v4f: backup size behind small L1
