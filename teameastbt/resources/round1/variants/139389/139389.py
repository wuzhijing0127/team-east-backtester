# v4e_stacked
# Stack v4b + v4a + v4d-safe (no buy_edge=1). Expected additive: ASH ~2500+, PEPPER ~3700. Target ~6200-6500.
"""
...
ASH_PARAMS = {
    ...
    "take_edge_buy": 2,         # v4a: more aggressive dip takes
    "take_edge_sell": 3,        # v4a: more aggressive top takes
    "k_inv": 2.5,
    "flatten_size": 10,
    "tier_medium": 0.4,
    "tier_high": 0.7,
...
PEPPER_PARAMS = {
    ...
    "dip_threshold": 3,           # v4d-safe: trigger dip boost sooner
    "take_profit_edge": 4,        # sell when bid > fair + this
    "min_long_frac": 0.96,        # v4d-safe: core = 48 units
    # Passive quoting
    "bid_spread": 4,
    "ask_spread": 8,
    "base_size": 10,
