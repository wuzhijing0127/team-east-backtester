...
# Config: micro_beta=0.4, imbalance_beta=0.1, base_skew=0.5, inventory_skew_k=1.0, ask_half_spread=4, join_improve_mode=1, take_sell_edge=4, take_buy_when_short_edge=2, take_sell_when_long_edge=2, quote_size_bid=10, quote_size_ask=20, tier_medium=0.5, tier_extreme=0.95, bid_mult_medium=0.25, ask_mult_medium=0.25, bid_mult_high=0.0, ask_mult_high=0.5, flatten_trigger=0.95, flatten_size=4, flatten_aggression=1
