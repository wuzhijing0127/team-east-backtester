...
# Config: micro_beta=0.2, base_skew=0.5, inventory_skew_k=4.0, bid_half_spread=8, join_improve_mode=0, take_sell_edge=1, take_buy_when_short_edge=1, take_sell_when_long_edge=1, quote_size_bid=4, quote_size_ask=6, tier_medium=0.5, tier_high=0.5, tier_extreme=0.85, bid_mult_medium=0.0, ask_mult_medium=0.25, flatten_trigger=0.8, flatten_size=8
