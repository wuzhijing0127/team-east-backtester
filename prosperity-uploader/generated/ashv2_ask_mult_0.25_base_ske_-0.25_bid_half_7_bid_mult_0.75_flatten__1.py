...
# Config: micro_beta=0.1, imbalance_beta=0.2, base_skew=-0.25, inventory_skew_k=1.5, bid_half_spread=7, join_improve_mode=0, take_buy_edge=3, take_sell_edge=1, take_buy_when_short_edge=2, take_sell_when_long_edge=2, quote_size_bid=18, quote_size_ask=16, tier_high=0.6, tier_extreme=0.85, bid_mult_medium=0.75, ask_mult_medium=0.25, flatten_aggression=1
