...
# Config: micro_beta=0.5, imbalance_beta=0.4, inventory_skew_k=3.0, bid_half_spread=2, ask_half_spread=7, join_improve_mode=1, take_buy_edge=1, take_sell_edge=1, take_buy_when_short_edge=2, take_sell_when_long_edge=2, quote_size_bid=4, quote_size_ask=18, tier_extreme=0.8, bid_mult_medium=0.75, ask_mult_medium=0.25, ask_mult_high=0.0, flatten_trigger=1.0, flatten_size=8, flatten_aggression=1
