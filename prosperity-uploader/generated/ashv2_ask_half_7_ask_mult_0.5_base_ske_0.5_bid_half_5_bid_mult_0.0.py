...
# Config: micro_beta=0.4, imbalance_beta=0.3, base_skew=0.5, bid_half_spread=5, ask_half_spread=7, join_improve_mode=1, take_buy_edge=0, take_sell_edge=3, take_buy_when_short_edge=1, take_sell_when_long_edge=1, quote_size_bid=8, quote_size_ask=20, tier_medium=0.6, tier_high=0.8, tier_extreme=0.95, bid_mult_high=0.0, ask_mult_high=0.5, flatten_trigger=0.85, flatten_size=12
