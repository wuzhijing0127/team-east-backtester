...
# Config: micro_beta=0.4, imbalance_beta=0.3, bid_half_spread=7, ask_half_spread=8, join_improve_mode=1, take_buy_edge=3, take_buy_when_short_edge=2, take_sell_when_long_edge=3, quote_size_bid=22, quote_size_ask=10, tier_medium=0.6, tier_high=0.6, bid_mult_medium=0.75, ask_mult_medium=1.0, ask_mult_high=0.5, flatten_trigger=0.8, flatten_size=14
