...
# Config: micro_beta=0.4, imbalance_beta=0.1, base_skew=0.25, inventory_skew_k=2.0, bid_half_spread=6, ask_half_spread=2, take_buy_edge=0, take_sell_edge=3, take_buy_when_short_edge=2, quote_size_bid=20, quote_size_ask=24, tier_medium=0.6, tier_high=0.8, tier_extreme=1.0, bid_mult_medium=0.75, ask_mult_medium=1.0, bid_mult_high=0.0, flatten_trigger=0.8, flatten_size=20
