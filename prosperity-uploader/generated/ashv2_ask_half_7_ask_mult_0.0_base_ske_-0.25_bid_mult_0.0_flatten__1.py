...
# Config: micro_beta=0.4, imbalance_beta=0.2, base_skew=-0.25, inventory_skew_k=4.0, ask_half_spread=7, join_improve_mode=0, take_buy_edge=1, take_sell_edge=1, take_buy_when_short_edge=2, take_sell_when_long_edge=1, quote_size_bid=16, quote_size_ask=16, tier_medium=0.5, tier_high=0.6, bid_mult_high=0.0, ask_mult_high=0.0, flatten_trigger=0.95, flatten_size=18, flatten_aggression=1
