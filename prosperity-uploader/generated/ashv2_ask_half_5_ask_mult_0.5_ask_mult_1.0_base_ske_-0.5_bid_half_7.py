...
# Config: micro_beta=0.2, base_skew=-0.5, inventory_skew_k=3.0, bid_half_spread=7, ask_half_spread=5, join_improve_mode=1, take_buy_edge=4, take_sell_edge=4, take_buy_when_short_edge=2, take_sell_when_long_edge=2, quote_size_bid=6, quote_size_ask=8, tier_extreme=0.95, bid_mult_medium=0.0, ask_mult_medium=1.0, bid_mult_high=0.0, ask_mult_high=0.5, flatten_trigger=0.75
