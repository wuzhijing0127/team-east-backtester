...
# Config: micro_beta=0.1, imbalance_beta=0.4, base_skew=-0.25, inventory_skew_k=1.0, bid_half_spread=4, ask_half_spread=4, join_improve_mode=1, take_sell_edge=1, take_buy_when_short_edge=2, take_sell_when_long_edge=1, quote_size_bid=24, quote_size_ask=6, tier_medium=0.5, tier_high=0.5, tier_extreme=0.85, bid_mult_medium=1.0, ask_mult_medium=1.0, bid_mult_high=0.0, flatten_size=8, flatten_aggression=1
