...
# Config: micro_beta=0.2, imbalance_beta=0.4, base_skew=-0.25, inventory_skew_k=3.0, ask_half_spread=5, join_improve_mode=1, take_sell_edge=3, take_buy_when_short_edge=1, quote_size_bid=18, quote_size_ask=20, tier_high=0.8, bid_mult_medium=0.25, ask_mult_medium=0.75, ask_mult_high=0.5, flatten_trigger=0.7, flatten_size=12
