...
# Config: micro_beta=0.2, imbalance_beta=0.2, base_skew=0.25, inventory_skew_k=2.0, bid_half_spread=5, ask_half_spread=4, join_improve_mode=1, take_buy_edge=0, take_buy_when_short_edge=2, take_sell_when_long_edge=1, quote_size_bid=6, quote_size_ask=4, tier_medium=0.5, tier_high=0.8, tier_extreme=0.95, bid_mult_medium=0.25, ask_mult_medium=0.75, flatten_trigger=0.85, flatten_size=18, flatten_aggression=1
