...
# Config: micro_beta=0.2, imbalance_beta=0.3, base_skew=-0.5, inventory_skew_k=1.5, bid_half_spread=2, ask_half_spread=8, join_improve_mode=1, take_buy_edge=4, take_sell_edge=4, take_buy_when_short_edge=2, take_sell_when_long_edge=2, quote_size_bid=24, quote_size_ask=16, tier_medium=0.5, tier_extreme=1.0, bid_mult_high=0.5, ask_mult_high=0.5, flatten_trigger=0.75
