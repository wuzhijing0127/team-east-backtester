...
# Config: micro_beta=0.5, imbalance_beta=0.4, base_skew=-0.25, inventory_skew_k=1.5, bid_half_spread=7, join_improve_mode=0, take_sell_edge=0, take_buy_when_short_edge=1, take_sell_when_long_edge=2, quote_size_bid=12, quote_size_ask=12, tier_medium=0.5, tier_high=0.6, ask_mult_medium=0.25, bid_mult_high=0.5, ask_mult_high=0.5, flatten_trigger=0.8, flatten_size=4
