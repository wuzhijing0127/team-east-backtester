...
# Config: micro_beta=0.1, imbalance_beta=0.4, base_skew=-0.5, inventory_skew_k=3.5, ask_half_spread=7, join_improve_mode=1, take_buy_edge=1, take_sell_edge=4, take_buy_when_short_edge=2, quote_size_bid=20, quote_size_ask=22, tier_medium=0.6, bid_mult_medium=0.75, ask_mult_medium=0.75, flatten_trigger=0.95, flatten_size=6, flatten_aggression=1
