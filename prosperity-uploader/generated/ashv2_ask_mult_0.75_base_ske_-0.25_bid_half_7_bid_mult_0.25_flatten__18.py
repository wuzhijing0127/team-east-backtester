...
# Config: micro_beta=0.2, base_skew=-0.25, inventory_skew_k=3.5, bid_half_spread=7, join_improve_mode=0, take_buy_edge=1, take_sell_edge=1, take_buy_when_short_edge=3, take_sell_when_long_edge=2, quote_size_bid=16, quote_size_ask=18, tier_medium=0.5, tier_high=0.6, tier_extreme=1.0, bid_mult_medium=0.25, ask_mult_medium=0.75, flatten_trigger=0.75, flatten_size=18
