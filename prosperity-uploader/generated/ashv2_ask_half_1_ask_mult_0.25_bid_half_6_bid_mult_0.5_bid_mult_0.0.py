...
# Config: imbalance_beta=0.1, inventory_skew_k=1.0, bid_half_spread=6, ask_half_spread=1, join_improve_mode=1, take_buy_when_short_edge=2, take_sell_when_long_edge=2, quote_size_bid=12, quote_size_ask=14, tier_medium=0.5, tier_high=0.5, tier_extreme=0.85, bid_mult_medium=0.0, ask_mult_medium=0.25, bid_mult_high=0.5, flatten_trigger=0.95, flatten_size=18
