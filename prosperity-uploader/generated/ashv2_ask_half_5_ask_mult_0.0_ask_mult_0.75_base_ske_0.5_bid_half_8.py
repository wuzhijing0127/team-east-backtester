...
# Config: micro_beta=0.2, imbalance_beta=0.1, base_skew=0.5, inventory_skew_k=2.0, bid_half_spread=8, ask_half_spread=5, join_improve_mode=1, take_sell_edge=1, take_buy_when_short_edge=3, take_sell_when_long_edge=2, quote_size_bid=20, quote_size_ask=6, tier_medium=0.3, tier_extreme=0.8, ask_mult_medium=0.75, bid_mult_high=0.0, ask_mult_high=0.0, flatten_trigger=0.85, flatten_size=16
