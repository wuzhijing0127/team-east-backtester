...
# Config: micro_beta=0.5, imbalance_beta=0.5, base_skew=-0.25, inventory_skew_k=4.0, bid_half_spread=5, ask_half_spread=8, join_improve_mode=1, take_buy_edge=1, take_buy_when_short_edge=1, take_sell_when_long_edge=3, quote_size_bid=20, quote_size_ask=6, tier_medium=0.5, tier_extreme=0.95, bid_mult_medium=0.75, ask_mult_medium=0.25, bid_mult_high=0.5, ask_mult_high=0.5, flatten_trigger=0.7, flatten_size=18, flatten_aggression=1
...
C = {
    ...
    "bid_mult_normal": 1.0,
    "ask_mult_normal": 1.0,
    "bid_mult_medium": 0.75,
    "ask_mult_medium": 0.25,
    "bid_mult_high": 0.5,
    "ask_mult_high": 0.5,
