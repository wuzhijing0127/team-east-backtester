...
# Config: micro_beta=0.5, imbalance_beta=0.4, base_skew=0.5, inventory_skew_k=3.5, bid_half_spread=6, ask_half_spread=2, join_improve_mode=1, take_sell_edge=0, take_buy_when_short_edge=2, take_sell_when_long_edge=1, quote_size_bid=18, quote_size_ask=14, tier_medium=0.5, tier_high=0.6, tier_extreme=0.8, bid_mult_medium=0.75, ask_mult_medium=0.25, bid_mult_high=0.5, flatten_trigger=0.8, flatten_size=20, flatten_aggression=1
