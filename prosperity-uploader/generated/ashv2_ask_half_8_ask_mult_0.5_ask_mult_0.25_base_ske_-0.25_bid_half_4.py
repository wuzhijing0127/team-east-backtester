...
# Config: micro_beta=0.2, imbalance_beta=0.5, base_skew=-0.25, inventory_skew_k=3.0, bid_half_spread=4, ask_half_spread=8, join_improve_mode=1, take_sell_edge=4, take_buy_when_short_edge=3, quote_size_bid=18, quote_size_ask=20, tier_medium=0.5, tier_high=0.5, bid_mult_medium=0.75, ask_mult_medium=0.25, ask_mult_high=0.5, flatten_trigger=1.0, flatten_size=14, flatten_aggression=1
