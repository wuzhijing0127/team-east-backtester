...
# Config: micro_beta=0.1, imbalance_beta=0.3, base_skew=0.5, inventory_skew_k=3.5, bid_half_spread=5, ask_half_spread=4, join_improve_mode=1, take_buy_edge=1, take_sell_edge=1, take_sell_when_long_edge=1, quote_size_bid=12, quote_size_ask=18, tier_medium=0.3, tier_high=0.5, tier_extreme=0.95, ask_mult_medium=0.0, bid_mult_high=0.5, flatten_trigger=0.95, flatten_size=6, flatten_aggression=1
