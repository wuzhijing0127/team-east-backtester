...
# Config: micro_beta=0.2, imbalance_beta=0.3, bid_half_spread=4, ask_half_spread=6, join_improve_mode=0, take_buy_edge=3, take_sell_edge=4, take_buy_when_short_edge=1, take_sell_when_long_edge=2, quote_size_bid=8, quote_size_ask=12, tier_medium=0.5, tier_high=0.8, tier_extreme=0.8, bid_mult_medium=0.25, ask_mult_medium=1.0, bid_mult_high=0.0, ask_mult_high=0.5, flatten_trigger=0.75, flatten_size=6, flatten_aggression=1
