...
# Config: micro_beta=0.1, imbalance_beta=0.1, base_skew=-0.25, inventory_skew_k=1.0, bid_half_spread=7, ask_half_spread=5, join_improve_mode=1, take_sell_edge=0, take_buy_when_short_edge=3, take_sell_when_long_edge=1, quote_size_bid=18, quote_size_ask=4, bid_mult_high=0.0, flatten_trigger=0.85, flatten_aggression=1
