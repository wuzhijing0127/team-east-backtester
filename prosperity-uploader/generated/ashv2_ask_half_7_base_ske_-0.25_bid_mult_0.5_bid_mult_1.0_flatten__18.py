...
# Config: micro_beta=0.3, imbalance_beta=0.1, base_skew=-0.25, inventory_skew_k=1.5, ask_half_spread=7, join_improve_mode=0, take_buy_edge=3, take_sell_edge=1, take_buy_when_short_edge=1, take_sell_when_long_edge=1, quote_size_bid=14, quote_size_ask=20, tier_medium=0.6, tier_high=0.8, tier_extreme=0.85, bid_mult_medium=1.0, bid_mult_high=0.5, flatten_size=18
