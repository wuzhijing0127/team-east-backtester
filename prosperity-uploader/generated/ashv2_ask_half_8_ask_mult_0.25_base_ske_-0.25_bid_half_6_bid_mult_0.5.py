...
# Config: micro_beta=0.1, imbalance_beta=0.2, base_skew=-0.25, inventory_skew_k=3.0, bid_half_spread=6, ask_half_spread=8, join_improve_mode=1, take_buy_edge=1, take_sell_edge=1, take_buy_when_short_edge=1, take_sell_when_long_edge=2, quote_size_bid=8, quote_size_ask=8, tier_medium=0.6, tier_high=0.6, tier_extreme=0.95, bid_mult_medium=0.25, ask_mult_medium=0.25, bid_mult_high=0.5, flatten_size=4, flatten_aggression=1
