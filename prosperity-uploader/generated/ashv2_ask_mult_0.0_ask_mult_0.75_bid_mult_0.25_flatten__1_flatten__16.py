...
# Config: imbalance_beta=0.4, take_buy_edge=3, take_sell_edge=3, take_sell_when_long_edge=3, quote_size_bid=12, quote_size_ask=6, tier_high=0.6, tier_extreme=0.95, bid_mult_medium=0.25, ask_mult_medium=0.75, ask_mult_high=0.0, flatten_trigger=0.75, flatten_size=16, flatten_aggression=1
