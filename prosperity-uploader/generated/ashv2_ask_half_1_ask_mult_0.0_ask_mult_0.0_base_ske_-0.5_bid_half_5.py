...
# Config: micro_beta=0.2, imbalance_beta=0.4, base_skew=-0.5, inventory_skew_k=3.5, bid_half_spread=5, ask_half_spread=1, join_improve_mode=0, take_buy_edge=4, take_sell_edge=4, take_buy_when_short_edge=1, take_sell_when_long_edge=1, quote_size_bid=6, quote_size_ask=8, tier_medium=0.5, tier_high=0.5, tier_extreme=0.85, bid_mult_medium=0.75, ask_mult_medium=0.0, bid_mult_high=0.5, ask_mult_high=0.0, flatten_trigger=0.8, flatten_size=14
