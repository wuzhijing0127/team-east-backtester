...
# Config: micro_beta=0.3, imbalance_beta=0.5, base_skew=-0.25, inventory_skew_k=3.0, bid_half_spread=8, ask_half_spread=2, take_buy_edge=4, take_sell_edge=1, take_buy_when_short_edge=1, take_sell_when_long_edge=2, quote_size_bid=22, quote_size_ask=8, tier_extreme=0.95, bid_mult_medium=0.75, ask_mult_medium=0.75, ask_mult_high=0.5, flatten_trigger=0.8, flatten_size=8, flatten_aggression=1
