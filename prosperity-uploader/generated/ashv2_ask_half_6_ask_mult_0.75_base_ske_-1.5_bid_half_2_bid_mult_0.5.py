...
# Config: micro_beta=1.75, imbalance_beta=1.5, base_skew=-1.5, bid_half_spread=2, ask_half_spread=6, join_improve_mode=1, take_buy_when_short_edge=1, take_sell_when_long_edge=1, quote_size_bid=24, quote_size_ask=6, tier_medium=0.5, tier_high=0.5, tier_extreme=0.8, bid_mult_medium=0.25, ask_mult_medium=0.75, bid_mult_high=0.5, flatten_aggression=1
