...
# Config: imbalance_beta=0.5, base_skew=0.25, inventory_skew_k=2.0, bid_half_spread=4, ask_half_spread=2, take_buy_edge=4, take_buy_when_short_edge=1, take_sell_when_long_edge=2, quote_size_bid=16, quote_size_ask=18, tier_medium=0.3, tier_high=0.6, bid_mult_medium=0.25, ask_mult_high=0.5, flatten_trigger=0.95, flatten_size=6, flatten_aggression=1
