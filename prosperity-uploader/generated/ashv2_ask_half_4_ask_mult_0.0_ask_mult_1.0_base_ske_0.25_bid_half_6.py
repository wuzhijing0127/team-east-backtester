...
# Config: micro_beta=0.2, imbalance_beta=0.2, base_skew=0.25, bid_half_spread=6, ask_half_spread=4, join_improve_mode=1, take_buy_edge=1, take_buy_when_short_edge=1, take_sell_when_long_edge=3, quote_size_bid=22, quote_size_ask=10, tier_medium=0.5, tier_extreme=0.85, bid_mult_medium=0.25, ask_mult_medium=1.0, bid_mult_high=0.0, ask_mult_high=0.0, flatten_trigger=0.75, flatten_size=4
