...
# Config: micro_beta=0.1, imbalance_beta=0.1, base_skew=0.25, inventory_skew_k=1.0, ask_half_spread=6, join_improve_mode=1, take_buy_edge=1, take_buy_when_short_edge=3, take_sell_when_long_edge=2, quote_size_bid=4, quote_size_ask=24, tier_medium=0.5, tier_high=0.5, tier_extreme=0.95, bid_mult_medium=1.0, ask_mult_medium=0.25, ask_mult_high=0.0, flatten_trigger=0.95, flatten_size=14
