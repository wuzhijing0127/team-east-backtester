...
# Config: micro_beta=0.3, imbalance_beta=0.3, inventory_skew_k=3.0, bid_half_spread=6, ask_half_spread=6, join_improve_mode=0, take_buy_edge=3, take_sell_edge=1, take_buy_when_short_edge=1, quote_size_bid=12, quote_size_ask=4, tier_medium=0.5, tier_high=0.8, tier_extreme=0.8, bid_mult_medium=0.75, ask_mult_medium=0.25, bid_mult_high=0.5, ask_mult_high=0.0, flatten_trigger=0.75, flatten_size=6
