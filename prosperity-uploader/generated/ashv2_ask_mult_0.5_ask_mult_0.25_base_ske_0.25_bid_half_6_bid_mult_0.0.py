...
# Config: micro_beta=0.3, imbalance_beta=0.1, base_skew=0.25, inventory_skew_k=3.0, bid_half_spread=6, join_improve_mode=0, take_buy_edge=1, take_sell_edge=4, take_buy_when_short_edge=2, take_sell_when_long_edge=1, quote_size_bid=16, quote_size_ask=14, tier_medium=0.3, tier_high=0.6, bid_mult_medium=0.75, ask_mult_medium=0.25, bid_mult_high=0.0, ask_mult_high=0.5, flatten_trigger=0.95, flatten_size=20, flatten_aggression=1
