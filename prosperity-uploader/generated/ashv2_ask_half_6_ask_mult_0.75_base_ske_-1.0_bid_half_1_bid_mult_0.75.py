...
# Config: micro_beta=0.75, imbalance_beta=2.0, base_skew=-1.0, inventory_skew_k=1.5, bid_half_spread=1, ask_half_spread=6, take_buy_edge=4, take_sell_edge=1, take_buy_when_short_edge=2, take_sell_when_long_edge=2, quote_size_bid=14, quote_size_ask=4, tier_medium=0.6, tier_high=0.8, bid_mult_medium=0.75, ask_mult_medium=0.75, flatten_trigger=0.8, flatten_size=20
