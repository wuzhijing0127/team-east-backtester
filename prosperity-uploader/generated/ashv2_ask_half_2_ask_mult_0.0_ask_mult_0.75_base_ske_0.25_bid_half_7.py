...
# Config: micro_beta=0.1, imbalance_beta=0.4, base_skew=0.25, inventory_skew_k=2.0, bid_half_spread=7, ask_half_spread=2, join_improve_mode=1, take_buy_edge=1, take_sell_edge=3, take_buy_when_short_edge=1, take_sell_when_long_edge=1, quote_size_bid=8, quote_size_ask=12, tier_medium=0.6, tier_high=0.6, tier_extreme=0.95, bid_mult_medium=1.0, ask_mult_medium=0.75, bid_mult_high=0.0, ask_mult_high=0.0, flatten_trigger=0.7, flatten_size=4, flatten_aggression=1
