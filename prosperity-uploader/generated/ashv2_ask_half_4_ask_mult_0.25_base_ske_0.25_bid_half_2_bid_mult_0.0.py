...
# Config: micro_beta=0.4, imbalance_beta=0.1, base_skew=0.25, inventory_skew_k=3.0, bid_half_spread=2, ask_half_spread=4, take_buy_edge=0, take_sell_edge=3, take_buy_when_short_edge=3, take_sell_when_long_edge=2, quote_size_bid=10, quote_size_ask=16, tier_medium=0.3, tier_high=0.6, bid_mult_medium=0.25, ask_mult_medium=0.25, bid_mult_high=0.0, flatten_trigger=0.8, flatten_size=18, flatten_aggression=1
