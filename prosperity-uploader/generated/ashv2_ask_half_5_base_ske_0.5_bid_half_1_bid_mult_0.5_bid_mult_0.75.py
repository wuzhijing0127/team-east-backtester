...
# Config: micro_beta=0.3, imbalance_beta=0.1, base_skew=0.5, inventory_skew_k=3.5, bid_half_spread=1, ask_half_spread=5, join_improve_mode=1, take_sell_edge=3, take_sell_when_long_edge=2, quote_size_bid=24, quote_size_ask=4, tier_medium=0.3, tier_extreme=0.85, bid_mult_medium=0.75, bid_mult_high=0.5, flatten_trigger=0.8, flatten_size=6, flatten_aggression=1
