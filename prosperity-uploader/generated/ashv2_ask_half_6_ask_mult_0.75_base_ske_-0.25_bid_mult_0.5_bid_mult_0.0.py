...
# Config: micro_beta=0.4, imbalance_beta=0.3, base_skew=-0.25, inventory_skew_k=1.5, ask_half_spread=6, join_improve_mode=1, take_sell_when_long_edge=1, quote_size_bid=24, quote_size_ask=8, tier_extreme=1.0, bid_mult_medium=0.0, ask_mult_medium=0.75, bid_mult_high=0.5, flatten_size=8
