...
# Config: micro_beta=0.2, imbalance_beta=0.5, inventory_skew_k=2.0, bid_half_spread=2, ask_half_spread=6, take_buy_edge=3, take_buy_when_short_edge=1, quote_size_bid=24, quote_size_ask=18, tier_high=0.5, tier_extreme=1.0, bid_mult_high=0.0, flatten_size=4, flatten_aggression=1
