...
# Config: micro_beta=0.3, imbalance_beta=0.5, base_skew=0.25, inventory_skew_k=2.0, bid_half_spread=8, ask_half_spread=1, join_improve_mode=1, take_buy_edge=3, take_sell_edge=3, take_buy_when_short_edge=2, take_sell_when_long_edge=1, quote_size_bid=24, quote_size_ask=14, tier_medium=0.6, bid_mult_medium=1.0, ask_mult_medium=0.0, bid_mult_high=0.0, flatten_size=16, flatten_aggression=1
