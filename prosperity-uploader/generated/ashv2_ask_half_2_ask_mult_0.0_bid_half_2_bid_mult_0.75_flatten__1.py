...
# Config: micro_beta=0.2, imbalance_beta=0.4, inventory_skew_k=1.0, bid_half_spread=2, ask_half_spread=2, join_improve_mode=0, take_buy_edge=1, take_sell_edge=0, take_buy_when_short_edge=2, quote_size_bid=4, quote_size_ask=12, tier_medium=0.5, tier_extreme=0.85, bid_mult_medium=0.75, ask_mult_medium=0.0, flatten_trigger=0.75, flatten_size=6, flatten_aggression=1
