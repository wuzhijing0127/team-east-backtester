...
# Config: micro_beta=0.1, imbalance_beta=0.5, base_skew=0.5, inventory_skew_k=1.5, bid_half_spread=6, ask_half_spread=8, take_sell_edge=1, take_buy_when_short_edge=1, take_sell_when_long_edge=2, quote_size_bid=14, quote_size_ask=18, tier_medium=0.3, tier_extreme=0.95, bid_mult_medium=0.0, ask_mult_medium=0.25, bid_mult_high=0.0, flatten_trigger=1.0, flatten_size=8
