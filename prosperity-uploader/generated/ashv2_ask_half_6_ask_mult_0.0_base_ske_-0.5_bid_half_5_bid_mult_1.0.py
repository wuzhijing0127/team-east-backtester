...
# Config: micro_beta=0.1, imbalance_beta=0.4, base_skew=-0.5, inventory_skew_k=1.5, bid_half_spread=5, ask_half_spread=6, take_buy_edge=0, take_sell_edge=0, take_buy_when_short_edge=2, take_sell_when_long_edge=2, quote_size_bid=24, quote_size_ask=18, tier_medium=0.3, tier_high=0.6, tier_extreme=0.85, bid_mult_medium=1.0, ask_mult_high=0.0, flatten_trigger=0.95, flatten_aggression=1
