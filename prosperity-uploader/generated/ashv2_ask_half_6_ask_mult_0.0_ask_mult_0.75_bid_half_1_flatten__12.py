...
# Config: micro_beta=0.3, imbalance_beta=0.3, inventory_skew_k=2.0, bid_half_spread=1, ask_half_spread=6, join_improve_mode=0, take_buy_edge=4, take_sell_edge=4, take_buy_when_short_edge=2, quote_size_bid=4, quote_size_ask=16, tier_high=0.6, tier_extreme=0.8, ask_mult_medium=0.75, ask_mult_high=0.0, flatten_trigger=0.75, flatten_size=12
