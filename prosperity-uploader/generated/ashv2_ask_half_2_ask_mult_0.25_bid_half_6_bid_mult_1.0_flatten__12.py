...
# Config: micro_beta=0.4, imbalance_beta=0.4, inventory_skew_k=3.5, bid_half_spread=6, ask_half_spread=2, join_improve_mode=1, take_sell_edge=4, take_buy_when_short_edge=3, take_sell_when_long_edge=2, quote_size_bid=8, quote_size_ask=4, tier_medium=0.5, tier_high=0.6, bid_mult_medium=1.0, ask_mult_medium=0.25, flatten_trigger=0.85, flatten_size=12
