...
# Config: micro_beta=0.3, base_skew=0.25, bid_half_spread=1, ask_half_spread=6, take_buy_edge=1, take_buy_when_short_edge=1, take_sell_when_long_edge=1, quote_size_bid=8, quote_size_ask=22, ask_mult_medium=1.0, bid_mult_high=0.0, flatten_trigger=0.8, flatten_size=18
