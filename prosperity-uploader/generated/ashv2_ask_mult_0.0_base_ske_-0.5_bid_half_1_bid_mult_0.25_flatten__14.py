...
# Config: micro_beta=0.4, imbalance_beta=0.4, base_skew=-0.5, inventory_skew_k=2.0, bid_half_spread=1, join_improve_mode=1, take_buy_edge=4, take_sell_edge=3, take_buy_when_short_edge=2, quote_size_bid=22, quote_size_ask=18, tier_extreme=0.85, bid_mult_medium=0.25, ask_mult_high=0.0, flatten_trigger=1.0, flatten_size=14
