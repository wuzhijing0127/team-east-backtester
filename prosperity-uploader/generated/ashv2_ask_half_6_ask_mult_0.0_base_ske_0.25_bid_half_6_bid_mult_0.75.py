...
# Config: micro_beta=0.3, imbalance_beta=0.3, base_skew=0.25, bid_half_spread=6, ask_half_spread=6, join_improve_mode=0, take_buy_edge=1, take_sell_edge=1, take_buy_when_short_edge=1, take_sell_when_long_edge=1, quote_size_bid=14, quote_size_ask=10, tier_high=0.8, tier_extreme=0.85, bid_mult_medium=0.75, ask_mult_medium=0.0, flatten_trigger=1.0, flatten_size=14, flatten_aggression=1
