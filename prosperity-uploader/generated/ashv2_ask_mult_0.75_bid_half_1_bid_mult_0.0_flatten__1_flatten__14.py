...
# Config: micro_beta=0.2, imbalance_beta=0.2, inventory_skew_k=4.0, bid_half_spread=1, take_buy_edge=1, take_sell_edge=1, take_buy_when_short_edge=2, quote_size_bid=24, quote_size_ask=12, tier_medium=0.5, tier_high=0.6, tier_extreme=0.95, bid_mult_medium=0.0, ask_mult_medium=0.75, flatten_size=14, flatten_aggression=1
