...
# Config: micro_beta=0.1, imbalance_beta=0.3, inventory_skew_k=4.0, bid_half_spread=7, ask_half_spread=7, join_improve_mode=1, take_sell_edge=1, take_buy_when_short_edge=2, take_sell_when_long_edge=3, quote_size_bid=24, quote_size_ask=10, tier_high=0.8, tier_extreme=1.0, bid_mult_medium=0.0, ask_mult_medium=0.75, bid_mult_high=0.0, ask_mult_high=0.5, flatten_trigger=0.95, flatten_size=6, flatten_aggression=1
