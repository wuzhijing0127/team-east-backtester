...
# Config: micro_beta=0.5, imbalance_beta=0.1, inventory_skew_k=2.0, bid_half_spread=7, ask_half_spread=1, join_improve_mode=1, take_sell_edge=4, take_buy_when_short_edge=3, take_sell_when_long_edge=2, quote_size_bid=16, quote_size_ask=4, tier_medium=0.6, tier_high=0.8, tier_extreme=1.0, bid_mult_high=0.0, flatten_aggression=1
