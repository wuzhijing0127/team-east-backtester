...
# Config: micro_beta=0.5, imbalance_beta=0.3, base_skew=-0.25, bid_half_spread=2, join_improve_mode=0, take_sell_edge=3, take_sell_when_long_edge=3, quote_size_bid=16, quote_size_ask=12, tier_medium=0.3, tier_extreme=0.95, bid_mult_medium=1.0, ask_mult_medium=0.25, flatten_trigger=0.7, flatten_size=14, flatten_aggression=1
