...
# Config: micro_beta=0.3, imbalance_beta=0.3, base_skew=-0.25, inventory_skew_k=3.0, bid_half_spread=5, ask_half_spread=7, join_improve_mode=1, take_buy_edge=0, take_buy_when_short_edge=1, take_sell_when_long_edge=1, quote_size_bid=8, quote_size_ask=14, tier_high=0.8, tier_extreme=1.0, ask_mult_medium=0.0, bid_mult_high=0.5, flatten_trigger=0.75, flatten_size=12, flatten_aggression=1
