...
# Config: micro_beta=0.5, imbalance_beta=1.0, inventory_skew_k=3.0, bid_half_spread=6, ask_half_spread=6, join_improve_mode=0, take_buy_edge=1, take_sell_edge=1, take_buy_when_short_edge=3, take_sell_when_long_edge=1, quote_size_bid=18, quote_size_ask=18, tier_medium=0.3, tier_extreme=0.95, bid_mult_medium=0.25, bid_mult_high=0.0, ask_mult_high=0.0, flatten_trigger=0.85, flatten_size=4, flatten_aggression=1
