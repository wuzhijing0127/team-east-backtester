...
# Config: micro_beta=0.4, imbalance_beta=0.4, inventory_skew_k=3.5, bid_half_spread=5, ask_half_spread=6, join_improve_mode=0, take_buy_edge=1, take_sell_edge=1, take_buy_when_short_edge=3, take_sell_when_long_edge=2, quote_size_bid=24, quote_size_ask=22, tier_medium=0.6, tier_extreme=0.8, bid_mult_medium=0.25, ask_mult_medium=0.75, bid_mult_high=0.5, flatten_trigger=0.7
