...
# Config: micro_beta=0.2, imbalance_beta=0.2, inventory_skew_k=3.0, bid_half_spread=5, ask_half_spread=2, join_improve_mode=1, take_buy_edge=3, take_buy_when_short_edge=2, take_sell_when_long_edge=3, quote_size_bid=22, quote_size_ask=8, tier_medium=0.3, tier_high=0.8, tier_extreme=0.8, ask_mult_high=0.5, flatten_trigger=0.75, flatten_size=6, flatten_aggression=1
