...
# Config: micro_beta=0.4, imbalance_beta=0.4, base_skew=0.25, inventory_skew_k=1.0, bid_half_spread=7, join_improve_mode=1, take_buy_edge=1, take_sell_edge=1, take_buy_when_short_edge=2, take_sell_when_long_edge=2, quote_size_bid=22, quote_size_ask=18, tier_high=0.6, tier_extreme=0.8, flatten_trigger=0.8, flatten_aggression=1
