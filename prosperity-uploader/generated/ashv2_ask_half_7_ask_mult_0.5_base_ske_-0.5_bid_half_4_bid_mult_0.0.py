...
# Config: imbalance_beta=0.5, base_skew=-0.5, bid_half_spread=4, ask_half_spread=7, join_improve_mode=1, take_buy_edge=3, take_sell_edge=0, take_buy_when_short_edge=3, take_sell_when_long_edge=2, quote_size_bid=12, quote_size_ask=20, tier_extreme=0.8, bid_mult_medium=0.75, bid_mult_high=0.0, ask_mult_high=0.5, flatten_trigger=0.95, flatten_size=14, flatten_aggression=1
