...
# Config: micro_beta=0.75, imbalance_beta=2.5, base_skew=0.5, inventory_skew_k=8.0, bid_half_spread=7, ask_half_spread=8, join_improve_mode=1, take_buy_edge=3, take_sell_edge=0, take_buy_when_short_edge=1, take_sell_when_long_edge=1, quote_size_bid=4, quote_size_ask=12, tier_medium=0.5, tier_high=0.6, tier_extreme=0.95, bid_mult_medium=0.25, ask_mult_medium=1.0, bid_mult_high=0.5, ask_mult_high=0.0, flatten_size=12
