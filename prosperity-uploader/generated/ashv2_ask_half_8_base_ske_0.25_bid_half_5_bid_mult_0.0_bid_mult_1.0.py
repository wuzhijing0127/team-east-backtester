...
# Config: micro_beta=0.3, imbalance_beta=0.5, base_skew=0.25, inventory_skew_k=2.0, bid_half_spread=5, ask_half_spread=8, take_buy_edge=3, take_sell_edge=0, take_buy_when_short_edge=2, take_sell_when_long_edge=1, quote_size_bid=8, quote_size_ask=20, tier_medium=0.5, tier_extreme=0.95, bid_mult_medium=1.0, bid_mult_high=0.0, flatten_size=16, flatten_aggression=1
