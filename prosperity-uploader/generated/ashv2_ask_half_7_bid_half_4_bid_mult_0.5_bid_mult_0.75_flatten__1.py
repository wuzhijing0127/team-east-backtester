...
# Config: micro_beta=0.1, imbalance_beta=0.2, inventory_skew_k=2.0, bid_half_spread=4, ask_half_spread=7, join_improve_mode=1, take_buy_edge=3, take_sell_when_long_edge=1, quote_size_bid=12, quote_size_ask=22, tier_medium=0.5, tier_high=0.6, tier_extreme=0.85, bid_mult_medium=0.75, bid_mult_high=0.5, flatten_trigger=0.95, flatten_size=12, flatten_aggression=1
