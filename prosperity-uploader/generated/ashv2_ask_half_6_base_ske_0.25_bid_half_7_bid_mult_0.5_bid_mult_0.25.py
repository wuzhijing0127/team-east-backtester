...
# Config: imbalance_beta=0.1, base_skew=0.25, inventory_skew_k=2.0, bid_half_spread=7, ask_half_spread=6, take_buy_edge=0, take_buy_when_short_edge=3, take_sell_when_long_edge=2, quote_size_bid=14, quote_size_ask=14, tier_medium=0.5, tier_high=0.8, tier_extreme=1.0, bid_mult_medium=0.25, bid_mult_high=0.5, flatten_trigger=0.85, flatten_size=12
