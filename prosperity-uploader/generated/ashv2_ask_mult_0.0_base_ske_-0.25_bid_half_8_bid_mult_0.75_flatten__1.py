...
# Config: micro_beta=0.5, imbalance_beta=0.1, base_skew=-0.25, inventory_skew_k=1.5, bid_half_spread=8, join_improve_mode=1, take_buy_edge=1, take_sell_edge=3, take_buy_when_short_edge=1, take_sell_when_long_edge=2, quote_size_bid=18, quote_size_ask=8, tier_medium=0.6, tier_high=0.8, tier_extreme=1.0, bid_mult_medium=0.75, ask_mult_high=0.0, flatten_trigger=0.7, flatten_size=14, flatten_aggression=1
