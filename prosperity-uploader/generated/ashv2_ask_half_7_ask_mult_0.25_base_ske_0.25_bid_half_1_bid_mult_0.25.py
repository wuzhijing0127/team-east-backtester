...
# Config: micro_beta=0.4, imbalance_beta=0.1, base_skew=0.25, inventory_skew_k=2.0, bid_half_spread=1, ask_half_spread=7, join_improve_mode=1, take_buy_edge=4, take_sell_edge=1, take_buy_when_short_edge=2, take_sell_when_long_edge=1, quote_size_bid=22, quote_size_ask=10, tier_medium=0.5, tier_extreme=0.95, bid_mult_medium=0.25, ask_mult_medium=0.25, flatten_trigger=0.75, flatten_size=16
