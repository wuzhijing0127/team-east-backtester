...
# Config: micro_beta=0.4, imbalance_beta=0.3, inventory_skew_k=3.5, ask_half_spread=1, join_improve_mode=1, take_buy_edge=1, take_sell_edge=3, take_sell_when_long_edge=1, quote_size_bid=8, quote_size_ask=12, tier_high=0.6, bid_mult_medium=0.25, ask_mult_medium=0.0, bid_mult_high=0.0, flatten_trigger=0.95, flatten_size=4
