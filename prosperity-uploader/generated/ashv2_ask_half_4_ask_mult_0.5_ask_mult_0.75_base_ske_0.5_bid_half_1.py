...
# Config: imbalance_beta=0.5, base_skew=0.5, inventory_skew_k=3.5, bid_half_spread=1, ask_half_spread=4, join_improve_mode=1, take_buy_edge=3, take_buy_when_short_edge=3, take_sell_when_long_edge=1, quote_size_bid=16, quote_size_ask=12, tier_high=0.6, tier_extreme=0.95, bid_mult_medium=0.25, ask_mult_medium=0.75, bid_mult_high=0.5, ask_mult_high=0.5, flatten_size=18
