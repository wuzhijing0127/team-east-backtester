...
# Config: micro_beta=0.2, imbalance_beta=0.3, base_skew=0.25, inventory_skew_k=1.0, bid_half_spread=5, ask_half_spread=4, join_improve_mode=1, take_buy_edge=1, take_sell_edge=4, take_buy_when_short_edge=1, take_sell_when_long_edge=2, quote_size_bid=16, quote_size_ask=22, tier_medium=0.6, tier_high=0.8, bid_mult_medium=0.75, bid_mult_high=0.0, ask_mult_high=0.0, flatten_trigger=0.75, flatten_size=20, flatten_aggression=1
