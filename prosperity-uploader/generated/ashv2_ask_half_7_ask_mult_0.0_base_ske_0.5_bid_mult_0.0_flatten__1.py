...
# Config: micro_beta=0.4, imbalance_beta=0.4, base_skew=0.5, inventory_skew_k=3.0, ask_half_spread=7, join_improve_mode=1, take_buy_edge=1, take_buy_when_short_edge=2, take_sell_when_long_edge=2, quote_size_bid=14, quote_size_ask=6, tier_high=0.6, tier_extreme=1.0, bid_mult_medium=0.0, ask_mult_medium=0.0, flatten_trigger=0.85, flatten_size=18, flatten_aggression=1
