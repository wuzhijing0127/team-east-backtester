...
# Config: micro_beta=0.4, imbalance_beta=0.2, base_skew=-0.25, inventory_skew_k=2.0, bid_half_spread=6, ask_half_spread=2, join_improve_mode=0, take_buy_edge=1, take_buy_when_short_edge=1, take_sell_when_long_edge=1, quote_size_bid=22, quote_size_ask=8, tier_medium=0.6, tier_high=0.6, tier_extreme=0.95, ask_mult_medium=0.75, flatten_trigger=0.75, flatten_size=16
