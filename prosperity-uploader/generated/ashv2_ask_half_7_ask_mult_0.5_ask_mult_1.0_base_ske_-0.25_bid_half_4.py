...
# Config: micro_beta=0.1, imbalance_beta=0.3, base_skew=-0.25, inventory_skew_k=1.5, bid_half_spread=4, ask_half_spread=7, join_improve_mode=1, take_sell_edge=3, take_sell_when_long_edge=2, quote_size_bid=10, quote_size_ask=24, tier_extreme=0.95, bid_mult_medium=0.25, ask_mult_medium=1.0, bid_mult_high=0.0, ask_mult_high=0.5, flatten_trigger=0.7, flatten_size=12
