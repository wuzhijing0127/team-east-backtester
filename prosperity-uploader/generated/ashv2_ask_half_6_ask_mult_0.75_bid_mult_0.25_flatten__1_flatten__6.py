...
# Config: imbalance_beta=0.1, inventory_skew_k=3.5, ask_half_spread=6, join_improve_mode=1, take_buy_edge=1, take_buy_when_short_edge=3, take_sell_when_long_edge=1, quote_size_bid=6, quote_size_ask=4, tier_medium=0.5, tier_high=0.5, tier_extreme=0.85, bid_mult_medium=0.25, ask_mult_medium=0.75, flatten_trigger=0.75, flatten_size=6, flatten_aggression=1
