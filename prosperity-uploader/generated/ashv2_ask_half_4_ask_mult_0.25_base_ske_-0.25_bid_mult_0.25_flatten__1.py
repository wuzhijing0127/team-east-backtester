...
# Config: micro_beta=0.1, imbalance_beta=0.1, base_skew=-0.25, inventory_skew_k=3.5, ask_half_spread=4, join_improve_mode=1, take_sell_edge=1, take_buy_when_short_edge=2, take_sell_when_long_edge=1, quote_size_bid=10, quote_size_ask=16, tier_extreme=1.0, bid_mult_medium=0.25, ask_mult_medium=0.25, flatten_trigger=0.8, flatten_size=8, flatten_aggression=1
