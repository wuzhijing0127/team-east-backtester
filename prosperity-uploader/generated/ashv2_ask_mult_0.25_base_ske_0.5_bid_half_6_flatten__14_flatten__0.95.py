...
# Config: micro_beta=0.1, imbalance_beta=0.4, base_skew=0.5, inventory_skew_k=3.5, bid_half_spread=6, join_improve_mode=1, take_buy_edge=0, take_sell_edge=0, take_buy_when_short_edge=2, take_sell_when_long_edge=1, quote_size_bid=10, quote_size_ask=10, tier_extreme=1.0, ask_mult_medium=0.25, flatten_trigger=0.95, flatten_size=14
