...
# Config: base_skew=-0.25, inventory_skew_k=3.5, bid_half_spread=7, ask_half_spread=6, take_buy_edge=3, take_sell_edge=3, take_sell_when_long_edge=2, quote_size_bid=6, quote_size_ask=12, tier_extreme=0.95, bid_mult_medium=0.75, bid_mult_high=0.5, ask_mult_high=0.5, flatten_trigger=0.75, flatten_size=16, flatten_aggression=1
