...
# Config: micro_beta=0.2, imbalance_beta=0.3, inventory_skew_k=2.0, bid_half_spread=8, ask_half_spread=5, take_buy_edge=4, take_sell_edge=0, take_buy_when_short_edge=3, quote_size_bid=10, quote_size_ask=20, tier_medium=0.5, tier_high=0.8, tier_extreme=0.8, bid_mult_high=0.5, ask_mult_high=0.0, flatten_size=4, flatten_aggression=1
