...
# Config: micro_beta=0.4, imbalance_beta=0.4, base_skew=-0.25, inventory_skew_k=4.0, bid_half_spread=2, ask_half_spread=6, join_improve_mode=0, take_buy_edge=3, take_sell_edge=0, take_sell_when_long_edge=3, quote_size_bid=14, quote_size_ask=14, tier_medium=0.3, tier_extreme=0.85, bid_mult_medium=0.75, ask_mult_medium=0.75, flatten_trigger=0.75, flatten_size=18, flatten_aggression=1
