...
# Config: micro_beta=0.3, imbalance_beta=0.1, base_skew=0.25, ask_half_spread=8, join_improve_mode=1, take_buy_edge=3, take_sell_edge=3, take_buy_when_short_edge=1, take_sell_when_long_edge=3, quote_size_bid=22, quote_size_ask=4, tier_medium=0.6, tier_extreme=0.95, bid_mult_medium=1.0, flatten_trigger=1.0, flatten_size=8
