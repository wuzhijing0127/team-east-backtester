...
# Config: micro_beta=0.3, imbalance_beta=0.3, inventory_skew_k=2.0, bid_half_spread=2, ask_half_spread=5, join_improve_mode=1, take_sell_edge=3, take_sell_when_long_edge=2, quote_size_bid=20, quote_size_ask=6, tier_medium=0.5, tier_extreme=0.95, bid_mult_medium=0.25, ask_mult_medium=1.0, ask_mult_high=0.5
