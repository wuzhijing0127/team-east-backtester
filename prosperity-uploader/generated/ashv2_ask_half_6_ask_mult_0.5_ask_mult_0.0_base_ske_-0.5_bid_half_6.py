...
# Config: micro_beta=0.5, imbalance_beta=0.2, base_skew=-0.5, inventory_skew_k=3.0, bid_half_spread=6, ask_half_spread=6, join_improve_mode=1, take_buy_edge=3, take_buy_when_short_edge=1, take_sell_when_long_edge=3, quote_size_bid=6, quote_size_ask=10, tier_high=0.6, tier_extreme=0.95, ask_mult_medium=0.0, bid_mult_high=0.5, ask_mult_high=0.5, flatten_trigger=0.75, flatten_size=18
