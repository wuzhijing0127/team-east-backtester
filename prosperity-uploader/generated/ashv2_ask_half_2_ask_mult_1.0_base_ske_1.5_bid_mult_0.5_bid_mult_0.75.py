...
# Config: micro_beta=1.25, imbalance_beta=2.0, base_skew=1.5, inventory_skew_k=3.0, ask_half_spread=2, join_improve_mode=0, take_sell_edge=0, take_buy_when_short_edge=2, take_sell_when_long_edge=3, quote_size_bid=10, quote_size_ask=6, tier_medium=0.5, tier_high=0.6, tier_extreme=0.85, bid_mult_medium=0.75, ask_mult_medium=1.0, bid_mult_high=0.5, flatten_trigger=0.95, flatten_size=8
