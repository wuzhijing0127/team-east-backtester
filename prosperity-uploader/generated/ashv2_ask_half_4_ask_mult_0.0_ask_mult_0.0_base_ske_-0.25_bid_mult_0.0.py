...
# Config: micro_beta=0.5, base_skew=-0.25, inventory_skew_k=2.0, ask_half_spread=4, join_improve_mode=0, take_buy_when_short_edge=2, take_sell_when_long_edge=1, quote_size_bid=10, quote_size_ask=14, tier_medium=0.3, tier_high=0.6, tier_extreme=0.85, bid_mult_medium=0.75, ask_mult_medium=0.0, bid_mult_high=0.0, ask_mult_high=0.0, flatten_trigger=0.95, flatten_size=18
