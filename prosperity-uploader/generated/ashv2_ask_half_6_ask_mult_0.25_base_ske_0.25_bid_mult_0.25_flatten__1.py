...
# Config: imbalance_beta=0.4, base_skew=0.25, ask_half_spread=6, join_improve_mode=1, take_buy_edge=0, take_sell_edge=0, take_sell_when_long_edge=2, quote_size_bid=20, quote_size_ask=20, tier_medium=0.3, bid_mult_medium=0.25, ask_mult_medium=0.25, flatten_trigger=0.95, flatten_size=8, flatten_aggression=1
