...
# Config: micro_beta=0.5, imbalance_beta=0.1, ask_half_spread=5, join_improve_mode=1, take_sell_edge=1, take_sell_when_long_edge=2, quote_size_bid=20, quote_size_ask=18, tier_medium=0.3, tier_high=0.5, tier_extreme=1.0, bid_mult_medium=0.25, ask_mult_medium=0.25, bid_mult_high=0.0, flatten_trigger=0.85
