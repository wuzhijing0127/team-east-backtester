...
# Config: micro_beta=0.3, imbalance_beta=0.2, base_skew=-0.25, inventory_skew_k=3.5, bid_half_spread=7, ask_half_spread=7, join_improve_mode=0, take_buy_edge=3, take_buy_when_short_edge=1, quote_size_bid=8, quote_size_ask=18, tier_medium=0.3, tier_high=0.5, tier_extreme=0.85, bid_mult_medium=0.0, ask_mult_high=0.0, flatten_trigger=0.85, flatten_size=4, flatten_aggression=1
