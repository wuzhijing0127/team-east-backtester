...
# Config: micro_beta=0.3, imbalance_beta=0.1, inventory_skew_k=1.0, bid_half_spread=6, ask_half_spread=6, join_improve_mode=0, take_buy_edge=3, take_sell_when_long_edge=1, quote_size_bid=4, quote_size_ask=20, tier_medium=0.5, tier_high=0.5, tier_extreme=0.95, bid_mult_medium=1.0, ask_mult_medium=0.0, bid_mult_high=0.5, ask_mult_high=0.5, flatten_trigger=0.95, flatten_size=16, flatten_aggression=1
