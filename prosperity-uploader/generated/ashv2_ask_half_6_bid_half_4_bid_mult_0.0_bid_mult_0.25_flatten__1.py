...
# Config: imbalance_beta=0.2, inventory_skew_k=1.5, bid_half_spread=4, ask_half_spread=6, join_improve_mode=1, take_sell_edge=3, take_buy_when_short_edge=2, take_sell_when_long_edge=1, quote_size_bid=4, quote_size_ask=8, tier_medium=0.5, tier_high=0.6, bid_mult_medium=0.25, bid_mult_high=0.0, flatten_trigger=0.95, flatten_size=18, flatten_aggression=1
