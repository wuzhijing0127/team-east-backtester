...
# Config: micro_beta=0.4, imbalance_beta=0.3, base_skew=-0.25, inventory_skew_k=4.0, bid_half_spread=6, join_improve_mode=1, take_buy_edge=0, take_buy_when_short_edge=1, take_sell_when_long_edge=2, quote_size_bid=6, quote_size_ask=12, tier_medium=0.5, tier_extreme=0.85, bid_mult_medium=1.0, ask_mult_medium=0.75, flatten_trigger=0.85, flatten_size=6
