...
# Config: micro_beta=0.2, imbalance_beta=0.2, bid_half_spread=6, join_improve_mode=0, take_buy_when_short_edge=2, take_sell_when_long_edge=3, quote_size_bid=16, quote_size_ask=16, ask_mult_medium=0.75, bid_mult_high=0.0, flatten_trigger=0.85, flatten_aggression=1
