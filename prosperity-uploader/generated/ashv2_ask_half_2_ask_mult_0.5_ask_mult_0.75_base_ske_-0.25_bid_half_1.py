...
# Config: micro_beta=0.4, imbalance_beta=0.3, base_skew=-0.25, inventory_skew_k=3.0, bid_half_spread=1, ask_half_spread=2, join_improve_mode=1, take_buy_edge=4, take_buy_when_short_edge=1, take_sell_when_long_edge=3, quote_size_bid=6, quote_size_ask=18, tier_medium=0.5, tier_extreme=0.95, ask_mult_medium=0.75, bid_mult_high=0.5, ask_mult_high=0.5, flatten_trigger=0.85, flatten_size=12
