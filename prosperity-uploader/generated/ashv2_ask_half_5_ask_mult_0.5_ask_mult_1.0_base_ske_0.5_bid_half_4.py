...
# Config: micro_beta=0.2, imbalance_beta=0.2, base_skew=0.5, bid_half_spread=4, ask_half_spread=5, join_improve_mode=1, take_sell_edge=0, take_buy_when_short_edge=3, take_sell_when_long_edge=1, quote_size_bid=22, quote_size_ask=6, tier_medium=0.6, tier_high=0.6, bid_mult_medium=1.0, ask_mult_medium=1.0, ask_mult_high=0.5, flatten_trigger=0.8, flatten_size=14
