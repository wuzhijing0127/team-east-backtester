...
# Config: imbalance_beta=0.2, base_skew=-0.25, inventory_skew_k=4.0, bid_half_spread=1, ask_half_spread=2, join_improve_mode=0, take_buy_edge=0, take_sell_edge=4, take_buy_when_short_edge=3, take_sell_when_long_edge=1, quote_size_bid=16, quote_size_ask=20, tier_high=0.6, tier_extreme=0.95, bid_mult_medium=0.25, bid_mult_high=0.5, flatten_trigger=0.7, flatten_size=16
