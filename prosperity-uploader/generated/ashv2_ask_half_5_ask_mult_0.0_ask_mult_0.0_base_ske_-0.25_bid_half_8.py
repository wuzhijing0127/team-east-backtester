...
# Config: micro_beta=0.5, imbalance_beta=0.4, base_skew=-0.25, inventory_skew_k=2.0, bid_half_spread=8, ask_half_spread=5, take_buy_edge=4, take_sell_edge=4, take_buy_when_short_edge=2, take_sell_when_long_edge=2, quote_size_bid=10, quote_size_ask=4, tier_medium=0.6, tier_high=0.6, tier_extreme=0.85, ask_mult_medium=0.0, bid_mult_high=0.5, ask_mult_high=0.0, flatten_trigger=0.95, flatten_size=8, flatten_aggression=1
