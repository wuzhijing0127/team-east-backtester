...
# Config: micro_beta=1.5, imbalance_beta=0.5, inventory_skew_k=0.5, bid_half_spread=4, join_improve_mode=1, take_buy_edge=3, take_buy_when_short_edge=1, take_sell_when_long_edge=1, quote_size_bid=10, quote_size_ask=6, tier_medium=0.5, tier_high=0.6, bid_mult_medium=0.25, ask_mult_medium=0.25, flatten_size=12, flatten_aggression=1
