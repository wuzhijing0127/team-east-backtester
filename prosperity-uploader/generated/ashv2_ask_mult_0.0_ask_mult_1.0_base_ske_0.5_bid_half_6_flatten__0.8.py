...
# Config: micro_beta=0.3, imbalance_beta=0.2, base_skew=0.5, inventory_skew_k=1.5, bid_half_spread=6, take_sell_edge=1, take_buy_when_short_edge=3, take_sell_when_long_edge=1, quote_size_bid=6, quote_size_ask=12, tier_medium=0.5, tier_high=0.6, tier_extreme=0.85, ask_mult_medium=1.0, ask_mult_high=0.0, flatten_trigger=0.8
