...
# Config: micro_beta=0.2, imbalance_beta=0.5, base_skew=-0.5, inventory_skew_k=3.5, bid_half_spread=2, ask_half_spread=1, join_improve_mode=1, take_buy_edge=4, take_sell_edge=4, take_buy_when_short_edge=1, take_sell_when_long_edge=1, quote_size_bid=4, quote_size_ask=18, tier_medium=0.5, tier_extreme=0.85, bid_mult_medium=0.75, ask_mult_medium=0.75, bid_mult_high=0.0, ask_mult_high=0.0, flatten_trigger=0.8, flatten_size=6, flatten_aggression=1
