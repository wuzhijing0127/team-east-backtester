...
# Config: micro_beta=0.25, imbalance_beta=2.5, inventory_skew_k=3.0, bid_half_spread=4, ask_half_spread=7, join_improve_mode=0, take_buy_edge=3, take_buy_when_short_edge=1, take_sell_when_long_edge=1, quote_size_bid=16, quote_size_ask=4, tier_medium=0.6, tier_high=0.6, tier_extreme=0.85, bid_mult_medium=1.0, ask_mult_medium=0.0, ask_mult_high=0.0, flatten_trigger=0.8, flatten_size=4
