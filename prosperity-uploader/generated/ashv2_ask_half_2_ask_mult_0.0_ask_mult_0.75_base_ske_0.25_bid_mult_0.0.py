...
# Config: micro_beta=0.4, imbalance_beta=0.1, base_skew=0.25, inventory_skew_k=3.0, ask_half_spread=2, join_improve_mode=1, take_buy_when_short_edge=2, quote_size_bid=16, quote_size_ask=6, tier_medium=0.3, tier_high=0.5, bid_mult_medium=0.0, ask_mult_medium=0.75, ask_mult_high=0.0, flatten_trigger=0.85, flatten_size=18
