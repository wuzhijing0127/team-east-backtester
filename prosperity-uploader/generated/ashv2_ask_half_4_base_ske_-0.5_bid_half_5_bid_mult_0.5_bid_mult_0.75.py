...
# Config: micro_beta=0.3, imbalance_beta=0.1, base_skew=-0.5, bid_half_spread=5, ask_half_spread=4, join_improve_mode=1, take_buy_edge=0, take_buy_when_short_edge=1, take_sell_when_long_edge=2, quote_size_bid=6, quote_size_ask=8, tier_medium=0.5, bid_mult_medium=0.75, bid_mult_high=0.5, flatten_trigger=1.0, flatten_size=8
