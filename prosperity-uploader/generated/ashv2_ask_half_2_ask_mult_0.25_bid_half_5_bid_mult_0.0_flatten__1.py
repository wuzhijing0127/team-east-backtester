...
# Config: micro_beta=0.3, imbalance_beta=0.5, inventory_skew_k=1.5, bid_half_spread=5, ask_half_spread=2, join_improve_mode=1, take_buy_edge=0, take_buy_when_short_edge=1, take_sell_when_long_edge=1, quote_size_bid=20, quote_size_ask=16, tier_high=0.8, tier_extreme=0.8, ask_mult_medium=0.25, bid_mult_high=0.0, flatten_size=8, flatten_aggression=1
