...
# Config: micro_beta=0.4, imbalance_beta=0.3, base_skew=0.25, inventory_skew_k=3.0, bid_half_spread=2, ask_half_spread=4, join_improve_mode=1, take_buy_edge=1, take_sell_edge=1, take_buy_when_short_edge=2, take_sell_when_long_edge=1, quote_size_bid=14, quote_size_ask=22, tier_high=0.6, tier_extreme=0.85, bid_mult_medium=0.75, ask_mult_medium=0.25, bid_mult_high=0.5, flatten_size=12
