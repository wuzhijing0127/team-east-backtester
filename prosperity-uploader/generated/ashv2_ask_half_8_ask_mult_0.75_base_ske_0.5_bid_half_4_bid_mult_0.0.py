...
# Config: micro_beta=0.1, imbalance_beta=0.2, base_skew=0.5, inventory_skew_k=3.5, bid_half_spread=4, ask_half_spread=8, join_improve_mode=0, take_sell_edge=1, take_buy_when_short_edge=1, take_sell_when_long_edge=1, quote_size_bid=10, quote_size_ask=10, tier_medium=0.5, tier_high=0.6, tier_extreme=0.85, bid_mult_medium=0.75, ask_mult_medium=0.75, bid_mult_high=0.0, flatten_trigger=1.0, flatten_aggression=1
