...
# Config: micro_beta=0.2, imbalance_beta=0.1, base_skew=-0.5, inventory_skew_k=2.0, bid_half_spread=4, ask_half_spread=5, join_improve_mode=0, take_buy_edge=1, take_sell_edge=1, take_buy_when_short_edge=2, take_sell_when_long_edge=1, quote_size_bid=18, quote_size_ask=6, tier_medium=0.3, tier_high=0.8, tier_extreme=0.85, bid_mult_high=0.5, ask_mult_high=0.0, flatten_trigger=0.8
