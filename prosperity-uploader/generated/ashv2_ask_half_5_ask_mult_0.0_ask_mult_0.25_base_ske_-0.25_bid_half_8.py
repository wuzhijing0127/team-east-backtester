...
# Config: micro_beta=0.1, imbalance_beta=0.1, base_skew=-0.25, inventory_skew_k=1.5, bid_half_spread=8, ask_half_spread=5, join_improve_mode=0, take_buy_edge=4, take_sell_edge=0, take_buy_when_short_edge=2, quote_size_bid=24, quote_size_ask=22, tier_medium=0.6, tier_extreme=1.0, bid_mult_medium=1.0, ask_mult_medium=0.25, bid_mult_high=0.0, ask_mult_high=0.0, flatten_size=6
