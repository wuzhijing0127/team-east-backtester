...
# Config: micro_beta=0.5, imbalance_beta=0.2, base_skew=0.25, inventory_skew_k=2.0, ask_half_spread=5, take_buy_edge=3, take_sell_edge=1, take_buy_when_short_edge=2, take_sell_when_long_edge=1, quote_size_bid=12, quote_size_ask=16, tier_medium=0.5, tier_high=0.6, tier_extreme=0.85, bid_mult_medium=0.0, ask_mult_medium=0.25, bid_mult_high=0.5, flatten_trigger=0.75, flatten_size=16, flatten_aggression=1
