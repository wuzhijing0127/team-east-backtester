...
# Config: micro_beta=0.1, inventory_skew_k=1.5, bid_half_spread=1, ask_half_spread=2, join_improve_mode=1, take_buy_edge=3, take_sell_edge=3, take_buy_when_short_edge=1, take_sell_when_long_edge=2, quote_size_bid=10, quote_size_ask=16, tier_medium=0.5, tier_extreme=1.0, bid_mult_medium=0.75, ask_mult_medium=0.0, ask_mult_high=0.5, flatten_trigger=0.7, flatten_aggression=1
