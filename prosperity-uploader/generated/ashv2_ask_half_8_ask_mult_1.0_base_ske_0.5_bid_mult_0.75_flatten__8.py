...
# Config: micro_beta=0.1, imbalance_beta=0.1, base_skew=0.5, inventory_skew_k=3.5, ask_half_spread=8, join_improve_mode=0, take_sell_edge=1, take_sell_when_long_edge=1, quote_size_bid=22, quote_size_ask=24, tier_medium=0.5, tier_high=0.8, bid_mult_medium=0.75, ask_mult_medium=1.0, flatten_trigger=0.85, flatten_size=8
