...
# Config: micro_beta=0.2, imbalance_beta=0.4, base_skew=0.25, inventory_skew_k=3.0, ask_half_spread=7, take_buy_edge=1, take_sell_edge=3, take_buy_when_short_edge=1, take_sell_when_long_edge=2, quote_size_bid=24, quote_size_ask=4, tier_extreme=0.8, bid_mult_medium=1.0, ask_mult_medium=0.0, bid_mult_high=0.5, flatten_trigger=0.95, flatten_aggression=1
