...
# Config: imbalance_beta=0.2, base_skew=0.25, inventory_skew_k=4.0, bid_half_spread=2, ask_half_spread=5, join_improve_mode=0, take_sell_edge=1, take_buy_when_short_edge=3, take_sell_when_long_edge=1, quote_size_bid=6, quote_size_ask=14, tier_medium=0.6, tier_high=0.6, tier_extreme=1.0, ask_mult_medium=0.25, ask_mult_high=0.5, flatten_trigger=0.95, flatten_size=16
