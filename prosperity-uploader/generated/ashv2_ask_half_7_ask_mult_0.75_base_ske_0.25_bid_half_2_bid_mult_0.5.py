...
# Config: micro_beta=0.2, imbalance_beta=0.2, base_skew=0.25, inventory_skew_k=1.5, bid_half_spread=2, ask_half_spread=7, join_improve_mode=1, take_sell_edge=1, take_buy_when_short_edge=3, take_sell_when_long_edge=3, quote_size_bid=4, quote_size_ask=6, tier_medium=0.5, tier_extreme=0.85, bid_mult_medium=0.0, ask_mult_medium=0.75, bid_mult_high=0.5, flatten_trigger=0.95, flatten_size=6, flatten_aggression=1
