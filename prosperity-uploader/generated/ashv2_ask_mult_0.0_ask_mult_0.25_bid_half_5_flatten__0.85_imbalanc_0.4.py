...
# Config: micro_beta=0.1, imbalance_beta=0.4, inventory_skew_k=1.5, bid_half_spread=5, take_buy_edge=3, take_sell_edge=0, take_buy_when_short_edge=2, take_sell_when_long_edge=1, quote_size_bid=20, quote_size_ask=14, tier_medium=0.3, ask_mult_medium=0.25, ask_mult_high=0.0, flatten_trigger=0.85
