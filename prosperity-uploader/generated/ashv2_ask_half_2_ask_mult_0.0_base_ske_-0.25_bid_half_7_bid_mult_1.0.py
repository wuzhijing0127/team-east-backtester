...
# Config: micro_beta=0.1, imbalance_beta=0.2, base_skew=-0.25, bid_half_spread=7, ask_half_spread=2, join_improve_mode=1, take_buy_edge=3, take_sell_edge=1, take_buy_when_short_edge=1, take_sell_when_long_edge=3, quote_size_bid=10, quote_size_ask=14, tier_medium=0.6, tier_extreme=0.95, bid_mult_medium=1.0, ask_mult_high=0.0, flatten_size=8
