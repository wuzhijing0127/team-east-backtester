...
# Config: micro_beta=0.3, imbalance_beta=0.3, base_skew=-0.25, bid_half_spread=2, ask_half_spread=2, join_improve_mode=0, take_buy_edge=4, take_buy_when_short_edge=2, take_sell_when_long_edge=1, quote_size_bid=12, quote_size_ask=22, tier_medium=0.5, tier_high=0.5, tier_extreme=0.85, bid_mult_medium=0.25, ask_mult_medium=0.75, ask_mult_high=0.0, flatten_trigger=0.85, flatten_size=14, flatten_aggression=1
