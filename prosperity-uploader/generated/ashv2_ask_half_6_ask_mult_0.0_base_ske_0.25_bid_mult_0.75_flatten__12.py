...
# Config: micro_beta=0.5, imbalance_beta=0.4, base_skew=0.25, inventory_skew_k=4.0, ask_half_spread=6, join_improve_mode=1, take_buy_edge=3, take_sell_edge=3, take_buy_when_short_edge=1, take_sell_when_long_edge=2, quote_size_bid=14, quote_size_ask=6, tier_extreme=0.8, bid_mult_medium=0.75, ask_mult_medium=0.0, flatten_trigger=0.95, flatten_size=12
