...
# Config: micro_beta=0.3, imbalance_beta=0.1, inventory_skew_k=3.0, ask_half_spread=5, take_buy_edge=4, take_buy_when_short_edge=1, take_sell_when_long_edge=1, quote_size_bid=10, quote_size_ask=4, tier_medium=0.5, bid_mult_medium=0.75, ask_mult_medium=0.75, bid_mult_high=0.5, ask_mult_high=0.5, flatten_trigger=0.75, flatten_size=12
