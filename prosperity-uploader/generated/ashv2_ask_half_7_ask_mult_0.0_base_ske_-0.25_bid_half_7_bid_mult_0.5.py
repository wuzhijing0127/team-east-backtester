...
# Config: micro_beta=0.5, imbalance_beta=0.3, base_skew=-0.25, inventory_skew_k=2.0, bid_half_spread=7, ask_half_spread=7, join_improve_mode=0, take_buy_edge=1, take_sell_edge=0, take_buy_when_short_edge=1, take_sell_when_long_edge=1, quote_size_bid=18, quote_size_ask=24, tier_high=0.6, tier_extreme=0.95, bid_mult_medium=0.75, ask_mult_medium=0.0, bid_mult_high=0.5, flatten_trigger=0.95, flatten_size=16, flatten_aggression=1
