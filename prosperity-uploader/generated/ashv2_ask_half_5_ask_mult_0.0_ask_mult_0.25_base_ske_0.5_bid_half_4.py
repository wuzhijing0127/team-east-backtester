...
# Config: micro_beta=0.4, imbalance_beta=0.1, base_skew=0.5, inventory_skew_k=3.5, bid_half_spread=4, ask_half_spread=5, join_improve_mode=1, take_buy_edge=3, take_sell_edge=0, take_buy_when_short_edge=1, take_sell_when_long_edge=3, quote_size_bid=12, quote_size_ask=24, tier_medium=0.5, ask_mult_medium=0.25, bid_mult_high=0.0, ask_mult_high=0.0, flatten_trigger=0.95, flatten_size=14, flatten_aggression=1
