...
# Config: micro_beta=0.1, imbalance_beta=0.3, base_skew=-0.25, inventory_skew_k=4.0, ask_half_spread=8, take_sell_edge=0, take_sell_when_long_edge=3, quote_size_bid=24, quote_size_ask=4, tier_medium=0.5, tier_high=0.5, tier_extreme=0.95, bid_mult_medium=1.0, ask_mult_medium=1.0, flatten_trigger=0.85, flatten_size=12, flatten_aggression=1
