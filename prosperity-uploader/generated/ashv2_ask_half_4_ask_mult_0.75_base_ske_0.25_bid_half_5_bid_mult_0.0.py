...
# Config: micro_beta=0.4, imbalance_beta=0.2, base_skew=0.25, inventory_skew_k=1.0, bid_half_spread=5, ask_half_spread=4, join_improve_mode=1, take_sell_edge=4, take_buy_when_short_edge=3, take_sell_when_long_edge=1, quote_size_bid=12, quote_size_ask=16, tier_medium=0.5, tier_high=0.6, bid_mult_medium=0.0, ask_mult_medium=0.75, flatten_size=4
