...
# Config: micro_beta=0.1, imbalance_beta=0.5, inventory_skew_k=3.0, ask_half_spread=2, join_improve_mode=1, take_buy_edge=1, take_buy_when_short_edge=1, quote_size_bid=20, quote_size_ask=10, tier_high=0.5, ask_mult_medium=1.0, ask_mult_high=0.0, flatten_size=12, flatten_aggression=1
