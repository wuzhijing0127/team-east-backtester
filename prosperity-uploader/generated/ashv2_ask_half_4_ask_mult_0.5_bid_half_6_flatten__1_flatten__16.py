...
# Config: micro_beta=0.4, imbalance_beta=0.3, inventory_skew_k=3.0, bid_half_spread=6, ask_half_spread=4, take_sell_edge=3, take_buy_when_short_edge=1, quote_size_bid=12, quote_size_ask=22, tier_medium=0.5, tier_high=0.8, ask_mult_high=0.5, flatten_trigger=0.7, flatten_size=16, flatten_aggression=1
