...
# Config: micro_beta=0.4, inventory_skew_k=3.5, bid_half_spread=2, ask_half_spread=8, join_improve_mode=1, take_buy_edge=1, take_sell_edge=1, take_sell_when_long_edge=3, quote_size_bid=20, quote_size_ask=16, tier_extreme=0.8, bid_mult_medium=0.25, ask_mult_medium=1.0, bid_mult_high=0.5, flatten_size=12
