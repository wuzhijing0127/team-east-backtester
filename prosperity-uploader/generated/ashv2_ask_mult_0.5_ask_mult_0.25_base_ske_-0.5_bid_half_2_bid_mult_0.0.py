...
# Config: micro_beta=0.3, imbalance_beta=0.1, base_skew=-0.5, bid_half_spread=2, take_buy_when_short_edge=3, take_sell_when_long_edge=2, quote_size_bid=24, quote_size_ask=4, tier_high=0.5, tier_extreme=0.8, bid_mult_medium=0.0, ask_mult_medium=0.25, ask_mult_high=0.5, flatten_trigger=0.7, flatten_size=8, flatten_aggression=1
