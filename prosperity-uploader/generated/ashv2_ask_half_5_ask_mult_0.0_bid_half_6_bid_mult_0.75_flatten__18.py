...
# Config: micro_beta=0.4, imbalance_beta=0.1, inventory_skew_k=2.0, bid_half_spread=6, ask_half_spread=5, take_buy_edge=0, take_sell_edge=4, take_buy_when_short_edge=1, quote_size_bid=4, quote_size_ask=10, tier_high=0.5, tier_extreme=0.95, bid_mult_medium=0.75, ask_mult_medium=0.0, flatten_trigger=0.75, flatten_size=18
