...
# Config: micro_beta=0.2, inventory_skew_k=3.0, take_buy_edge=1, quote_size_bid=24, quote_size_ask=6, tier_extreme=0.8, bid_mult_medium=0.25, ask_mult_medium=0.25, ask_mult_high=0.0, flatten_trigger=0.85, flatten_size=4
