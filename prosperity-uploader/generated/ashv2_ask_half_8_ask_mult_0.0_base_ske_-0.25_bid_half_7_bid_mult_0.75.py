...
# Config: micro_beta=0.4, imbalance_beta=0.5, base_skew=-0.25, inventory_skew_k=3.5, bid_half_spread=7, ask_half_spread=8, join_improve_mode=0, take_sell_edge=1, take_buy_when_short_edge=2, take_sell_when_long_edge=1, quote_size_bid=14, quote_size_ask=6, tier_medium=0.5, tier_high=0.6, tier_extreme=0.85, bid_mult_medium=0.75, ask_mult_medium=0.0, flatten_trigger=0.75, flatten_size=4
