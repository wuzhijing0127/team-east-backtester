...
# Config: micro_beta=0.4, base_skew=0.25, inventory_skew_k=3.0, bid_half_spread=5, join_improve_mode=1, take_buy_edge=1, take_sell_edge=3, take_sell_when_long_edge=2, quote_size_bid=10, quote_size_ask=22, tier_medium=0.5, tier_high=0.8, ask_mult_medium=0.75, ask_mult_high=0.5, flatten_trigger=0.85, flatten_size=6
