...
# Config: micro_beta=0.4, imbalance_beta=0.2, base_skew=-0.25, inventory_skew_k=3.5, ask_half_spread=7, join_improve_mode=1, take_buy_edge=1, take_sell_edge=1, quote_size_bid=18, quote_size_ask=10, tier_medium=0.3, tier_extreme=0.85, bid_mult_medium=1.0, bid_mult_high=0.5, flatten_trigger=0.8, flatten_size=6
