...
# Config: micro_beta=0.1, imbalance_beta=0.4, base_skew=0.25, inventory_skew_k=1.0, bid_half_spread=4, ask_half_spread=4, join_improve_mode=1, take_buy_edge=4, take_sell_edge=0, take_buy_when_short_edge=2, take_sell_when_long_edge=2, quote_size_bid=14, quote_size_ask=24, tier_high=0.8, bid_mult_medium=0.75, ask_mult_medium=0.25, bid_mult_high=0.0, ask_mult_high=0.0, flatten_trigger=0.75, flatten_size=14, flatten_aggression=1
