...
# Config: micro_beta=0.2, imbalance_beta=0.1, base_skew=0.25, inventory_skew_k=1.5, bid_half_spread=7, ask_half_spread=6, join_improve_mode=1, take_buy_edge=3, take_buy_when_short_edge=3, take_sell_when_long_edge=3, quote_size_bid=8, quote_size_ask=12, tier_high=0.6, tier_extreme=0.95, bid_mult_high=0.0, flatten_trigger=0.95, flatten_size=8, flatten_aggression=1
