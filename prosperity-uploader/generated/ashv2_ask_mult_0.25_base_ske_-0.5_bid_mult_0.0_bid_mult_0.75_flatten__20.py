...
# Config: micro_beta=0.3, imbalance_beta=0.3, base_skew=-0.5, join_improve_mode=1, take_buy_edge=4, take_sell_edge=3, quote_size_bid=16, quote_size_ask=16, tier_medium=0.3, tier_high=0.5, tier_extreme=1.0, bid_mult_medium=0.75, ask_mult_medium=0.25, bid_mult_high=0.0, flatten_trigger=0.85, flatten_size=20
