...
# Config: micro_beta=0.4, imbalance_beta=0.5, base_skew=-0.25, inventory_skew_k=1.5, bid_half_spread=7, ask_half_spread=2, take_buy_edge=0, take_sell_edge=1, take_buy_when_short_edge=2, quote_size_bid=12, quote_size_ask=12, ask_mult_medium=0.75, ask_mult_high=0.5, flatten_trigger=0.7, flatten_size=12
