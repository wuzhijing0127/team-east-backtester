...
# Config: micro_beta=0.1, imbalance_beta=0.1, inventory_skew_k=3.5, bid_half_spread=2, ask_half_spread=1, join_improve_mode=0, take_buy_edge=3, take_sell_edge=1, take_sell_when_long_edge=1, quote_size_bid=16, quote_size_ask=24, bid_mult_medium=0.75, ask_mult_medium=0.0, flatten_trigger=0.95, flatten_size=20
