...
# Config: micro_beta=0.2, base_skew=-0.25, inventory_skew_k=2.0, bid_half_spread=2, ask_half_spread=4, take_sell_when_long_edge=1, quote_size_bid=8, quote_size_ask=12, tier_high=0.6, tier_extreme=1.0, bid_mult_medium=0.0, ask_mult_medium=0.75, ask_mult_high=0.5, flatten_trigger=0.75, flatten_size=16, flatten_aggression=1
