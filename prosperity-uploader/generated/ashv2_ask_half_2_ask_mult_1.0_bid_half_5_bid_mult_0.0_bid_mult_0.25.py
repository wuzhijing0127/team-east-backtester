...
# Config: micro_beta=0.2, inventory_skew_k=3.5, bid_half_spread=5, ask_half_spread=2, take_sell_edge=4, take_buy_when_short_edge=2, take_sell_when_long_edge=3, quote_size_bid=24, quote_size_ask=18, tier_medium=0.5, tier_high=0.6, tier_extreme=0.95, bid_mult_medium=0.25, ask_mult_medium=1.0, bid_mult_high=0.0, flatten_trigger=1.0, flatten_size=20
