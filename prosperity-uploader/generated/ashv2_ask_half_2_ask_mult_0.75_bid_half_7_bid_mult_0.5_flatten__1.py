...
# Config: imbalance_beta=0.1, inventory_skew_k=3.5, bid_half_spread=7, ask_half_spread=2, take_buy_edge=3, take_buy_when_short_edge=1, take_sell_when_long_edge=2, quote_size_bid=6, quote_size_ask=8, tier_medium=0.5, tier_extreme=0.8, ask_mult_medium=0.75, bid_mult_high=0.5, flatten_trigger=1.0, flatten_size=16, flatten_aggression=1
