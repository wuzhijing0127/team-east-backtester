...
# Config: micro_beta=0.1, imbalance_beta=0.3, base_skew=0.25, inventory_skew_k=2.0, bid_half_spread=2, ask_half_spread=5, join_improve_mode=0, take_buy_edge=3, take_buy_when_short_edge=2, take_sell_when_long_edge=3, quote_size_bid=14, quote_size_ask=8, tier_medium=0.3, tier_high=0.5, tier_extreme=0.85, ask_mult_medium=1.0, flatten_size=4, flatten_aggression=1
