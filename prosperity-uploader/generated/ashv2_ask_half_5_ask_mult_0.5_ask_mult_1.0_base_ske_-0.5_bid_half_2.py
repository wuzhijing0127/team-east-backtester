...
# Config: micro_beta=0.4, base_skew=-0.5, bid_half_spread=2, ask_half_spread=5, join_improve_mode=0, take_buy_edge=1, take_sell_edge=3, take_buy_when_short_edge=1, take_sell_when_long_edge=2, quote_size_bid=10, quote_size_ask=6, tier_high=0.6, tier_extreme=0.8, bid_mult_medium=1.0, ask_mult_medium=1.0, ask_mult_high=0.5, flatten_trigger=0.8, flatten_size=16, flatten_aggression=1
