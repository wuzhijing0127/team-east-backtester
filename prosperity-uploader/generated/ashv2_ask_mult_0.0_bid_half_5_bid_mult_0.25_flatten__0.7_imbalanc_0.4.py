...
# Config: imbalance_beta=0.4, bid_half_spread=5, join_improve_mode=1, take_buy_edge=3, take_buy_when_short_edge=2, take_sell_when_long_edge=2, quote_size_bid=20, quote_size_ask=12, tier_medium=0.5, tier_high=0.8, tier_extreme=0.95, bid_mult_medium=0.25, ask_mult_high=0.0, flatten_trigger=0.7
