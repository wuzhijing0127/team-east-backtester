...
# Config: micro_beta=0.3, imbalance_beta=0.4, base_skew=-0.25, inventory_skew_k=4.0, bid_half_spread=5, ask_half_spread=2, take_buy_edge=3, take_buy_when_short_edge=2, quote_size_bid=10, quote_size_ask=6, tier_medium=0.6, tier_high=0.6, tier_extreme=0.95, bid_mult_medium=0.25, ask_mult_medium=0.75, ask_mult_high=0.5, flatten_trigger=0.8, flatten_size=4, flatten_aggression=1
