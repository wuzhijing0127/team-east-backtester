...
# Config: imbalance_beta=0.3, base_skew=-0.5, inventory_skew_k=3.5, bid_half_spread=6, ask_half_spread=4, take_buy_edge=1, take_sell_edge=3, take_buy_when_short_edge=1, quote_size_bid=20, quote_size_ask=20, tier_medium=0.6, tier_high=0.6, tier_extreme=0.85, bid_mult_medium=1.0, ask_mult_medium=0.75, flatten_trigger=0.75, flatten_size=18, flatten_aggression=1
