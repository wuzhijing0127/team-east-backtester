...
# Config: imbalance_beta=0.4, bid_half_spread=4, ask_half_spread=5, take_buy_edge=3, take_sell_edge=3, take_buy_when_short_edge=1, take_sell_when_long_edge=1, quote_size_bid=20, quote_size_ask=10, tier_medium=0.5, tier_high=0.6, tier_extreme=0.85, bid_mult_medium=0.75, bid_mult_high=0.0, flatten_trigger=1.0, flatten_size=8
