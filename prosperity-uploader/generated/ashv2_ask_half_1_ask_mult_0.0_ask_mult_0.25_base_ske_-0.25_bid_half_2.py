...
# Config: micro_beta=0.1, imbalance_beta=0.2, base_skew=-0.25, inventory_skew_k=1.0, bid_half_spread=2, ask_half_spread=1, take_buy_edge=3, take_sell_edge=4, take_sell_when_long_edge=3, quote_size_bid=16, quote_size_ask=16, tier_medium=0.3, tier_high=0.8, ask_mult_medium=0.25, ask_mult_high=0.0, flatten_trigger=0.8, flatten_size=8, flatten_aggression=1
