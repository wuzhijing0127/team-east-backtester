...
# Config: micro_beta=0.2, imbalance_beta=0.2, base_skew=0.5, inventory_skew_k=4.0, bid_half_spread=7, ask_half_spread=1, join_improve_mode=0, take_sell_edge=1, take_buy_when_short_edge=2, take_sell_when_long_edge=3, quote_size_bid=22, quote_size_ask=4, tier_high=0.6, bid_mult_medium=0.25, ask_mult_medium=0.75, ask_mult_high=0.5, flatten_trigger=0.85, flatten_size=14, flatten_aggression=1
