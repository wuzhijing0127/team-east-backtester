...
# Config: micro_beta=0.4, imbalance_beta=0.3, base_skew=0.5, inventory_skew_k=3.5, ask_half_spread=1, take_buy_edge=4, take_sell_edge=3, take_buy_when_short_edge=3, take_sell_when_long_edge=2, quote_size_bid=4, quote_size_ask=10, tier_high=0.6, tier_extreme=1.0, flatten_trigger=0.8, flatten_size=18
