...
# Config: micro_beta=0.5, imbalance_beta=3.0, base_skew=1.5, inventory_skew_k=1.0, bid_half_spread=5, ask_half_spread=2, join_improve_mode=0, take_buy_edge=4, take_buy_when_short_edge=1, quote_size_bid=6, quote_size_ask=6, tier_medium=0.5, tier_high=0.8, tier_extreme=0.85, bid_mult_medium=0.25, ask_mult_medium=0.75, ask_mult_high=0.0, flatten_size=16
