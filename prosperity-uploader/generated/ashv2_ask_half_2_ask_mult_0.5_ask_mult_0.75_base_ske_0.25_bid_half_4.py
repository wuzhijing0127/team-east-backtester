...
# Config: micro_beta=0.1, imbalance_beta=0.2, base_skew=0.25, inventory_skew_k=1.5, bid_half_spread=4, ask_half_spread=2, join_improve_mode=1, take_buy_when_short_edge=3, quote_size_bid=22, quote_size_ask=18, tier_medium=0.5, tier_high=0.6, bid_mult_medium=0.25, ask_mult_medium=0.75, bid_mult_high=0.5, ask_mult_high=0.5, flatten_size=14
