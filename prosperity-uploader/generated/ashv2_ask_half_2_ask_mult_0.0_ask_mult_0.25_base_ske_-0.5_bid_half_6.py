...
# Config: micro_beta=0.1, imbalance_beta=0.4, base_skew=-0.5, inventory_skew_k=3.0, bid_half_spread=6, ask_half_spread=2, join_improve_mode=0, take_sell_edge=3, take_sell_when_long_edge=1, quote_size_bid=18, quote_size_ask=20, tier_high=0.5, tier_extreme=0.95, bid_mult_medium=0.75, ask_mult_medium=0.25, bid_mult_high=0.0, ask_mult_high=0.0, flatten_trigger=0.85, flatten_size=6
