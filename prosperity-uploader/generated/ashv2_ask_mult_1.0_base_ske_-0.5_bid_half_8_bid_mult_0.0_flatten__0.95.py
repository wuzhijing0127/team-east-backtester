...
# Config: micro_beta=0.3, base_skew=-0.5, inventory_skew_k=1.5, bid_half_spread=8, join_improve_mode=1, take_buy_edge=1, take_sell_edge=1, take_buy_when_short_edge=1, take_sell_when_long_edge=2, quote_size_bid=8, quote_size_ask=20, tier_high=0.6, tier_extreme=0.85, ask_mult_medium=1.0, bid_mult_high=0.0, flatten_trigger=0.95
