...
# Config: micro_beta=0.4, imbalance_beta=0.2, inventory_skew_k=1.5, bid_half_spread=4, ask_half_spread=7, take_buy_edge=3, take_sell_edge=1, take_buy_when_short_edge=1, take_sell_when_long_edge=2, quote_size_bid=10, quote_size_ask=12, tier_medium=0.5, tier_extreme=0.8, bid_mult_medium=0.25, ask_mult_medium=0.25, ask_mult_high=0.0, flatten_trigger=1.0, flatten_size=12
