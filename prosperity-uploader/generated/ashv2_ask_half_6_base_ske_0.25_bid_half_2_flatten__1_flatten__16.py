...
# Config: micro_beta=0.2, base_skew=0.25, bid_half_spread=2, ask_half_spread=6, join_improve_mode=0, take_buy_edge=3, take_sell_edge=3, take_buy_when_short_edge=1, quote_size_bid=14, quote_size_ask=14, tier_medium=0.6, tier_high=0.6, flatten_size=16, flatten_aggression=1
