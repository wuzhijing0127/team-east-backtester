...
# Config: micro_beta=0.4, imbalance_beta=0.1, inventory_skew_k=1.5, bid_half_spread=4, ask_half_spread=5, join_improve_mode=1, take_buy_edge=4, take_sell_edge=0, take_buy_when_short_edge=3, take_sell_when_long_edge=2, quote_size_bid=8, quote_size_ask=24, tier_extreme=1.0, bid_mult_medium=1.0, ask_mult_medium=0.75, ask_mult_high=0.0, flatten_trigger=1.0, flatten_size=8
