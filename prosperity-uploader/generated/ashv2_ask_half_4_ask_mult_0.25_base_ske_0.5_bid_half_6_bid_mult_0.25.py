...
# Config: micro_beta=0.1, imbalance_beta=0.4, base_skew=0.5, bid_half_spread=6, ask_half_spread=4, join_improve_mode=1, take_buy_edge=1, take_sell_edge=3, take_buy_when_short_edge=2, take_sell_when_long_edge=2, quote_size_bid=6, quote_size_ask=14, tier_high=0.5, tier_extreme=0.85, bid_mult_medium=0.25, ask_mult_medium=0.25, flatten_trigger=0.8, flatten_size=4
