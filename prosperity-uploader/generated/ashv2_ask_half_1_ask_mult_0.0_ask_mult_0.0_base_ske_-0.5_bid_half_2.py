...
# Config: micro_beta=0.1, imbalance_beta=0.5, base_skew=-0.5, inventory_skew_k=1.5, bid_half_spread=2, ask_half_spread=1, join_improve_mode=1, take_buy_edge=0, take_sell_edge=3, take_buy_when_short_edge=1, take_sell_when_long_edge=1, quote_size_bid=14, quote_size_ask=10, tier_medium=0.5, tier_high=0.6, tier_extreme=0.95, bid_mult_medium=0.75, ask_mult_medium=0.0, ask_mult_high=0.0, flatten_trigger=0.7, flatten_size=6, flatten_aggression=1
