...
# Config: micro_beta=0.3, imbalance_beta=0.2, base_skew=0.25, inventory_skew_k=3.0, bid_half_spread=5, ask_half_spread=6, join_improve_mode=0, take_buy_edge=0, take_sell_edge=3, take_sell_when_long_edge=2, quote_size_bid=12, quote_size_ask=18, tier_medium=0.6, tier_high=0.8, bid_mult_medium=0.75, flatten_trigger=0.95, flatten_size=4, flatten_aggression=1
