...
# Config: micro_beta=0.2, imbalance_beta=0.5, base_skew=0.25, inventory_skew_k=3.0, bid_half_spread=2, ask_half_spread=7, take_buy_when_short_edge=1, quote_size_bid=18, quote_size_ask=16, tier_medium=0.5, tier_high=0.5, tier_extreme=0.85, bid_mult_medium=0.75, ask_mult_medium=0.0, bid_mult_high=0.0, ask_mult_high=0.0, flatten_trigger=0.75, flatten_size=12
