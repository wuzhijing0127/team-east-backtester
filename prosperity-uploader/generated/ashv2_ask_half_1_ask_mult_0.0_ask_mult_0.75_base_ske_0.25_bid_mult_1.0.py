...
# Config: micro_beta=0.2, base_skew=0.25, inventory_skew_k=3.0, ask_half_spread=1, take_buy_edge=1, take_sell_when_long_edge=1, quote_size_bid=20, quote_size_ask=18, tier_medium=0.6, tier_high=0.6, tier_extreme=0.95, bid_mult_medium=1.0, ask_mult_medium=0.75, ask_mult_high=0.0, flatten_size=14
