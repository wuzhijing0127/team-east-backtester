...
# Config: micro_beta=0.25, inventory_skew_k=3.5, bid_half_spread=4, take_buy_edge=0, take_sell_edge=4, take_sell_when_long_edge=3, quote_size_bid=4, quote_size_ask=3, tier_medium=0.3, tier_high=0.6, tier_extreme=0.85, bid_mult_medium=1.0, ask_mult_medium=1.0, bid_mult_high=0.0, ask_mult_high=0.5, flatten_trigger=0.75, flatten_size=20, flatten_aggression=1
