...
# Config: micro_beta=0.1, imbalance_beta=0.2, base_skew=0.25, inventory_skew_k=1.5, bid_half_spread=4, ask_half_spread=7, take_buy_edge=1, take_sell_edge=1, take_buy_when_short_edge=3, quote_size_bid=12, quote_size_ask=24, tier_medium=0.5, tier_extreme=0.8, bid_mult_medium=0.75, ask_mult_high=0.0, flatten_trigger=0.85, flatten_size=4
