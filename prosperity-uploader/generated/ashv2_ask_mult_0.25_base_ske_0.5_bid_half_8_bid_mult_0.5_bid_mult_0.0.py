...
# Config: micro_beta=0.4, base_skew=0.5, inventory_skew_k=1.5, bid_half_spread=8, join_improve_mode=0, take_buy_when_short_edge=3, take_sell_when_long_edge=1, quote_size_bid=18, quote_size_ask=4, tier_high=0.8, bid_mult_medium=0.0, ask_mult_medium=0.25, bid_mult_high=0.5, flatten_trigger=0.85, flatten_size=6
