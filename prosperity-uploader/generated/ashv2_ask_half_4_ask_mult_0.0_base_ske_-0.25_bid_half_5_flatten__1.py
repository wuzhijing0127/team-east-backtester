...
# Config: micro_beta=0.3, imbalance_beta=0.1, base_skew=-0.25, inventory_skew_k=3.5, bid_half_spread=5, ask_half_spread=4, take_sell_edge=1, take_buy_when_short_edge=1, take_sell_when_long_edge=2, quote_size_bid=6, quote_size_ask=20, tier_medium=0.5, tier_high=0.6, tier_extreme=0.95, ask_mult_high=0.0, flatten_trigger=0.8, flatten_aggression=1
