...
# Config: micro_beta=0.3, imbalance_beta=0.4, base_skew=0.5, bid_half_spread=5, ask_half_spread=7, join_improve_mode=1, take_buy_edge=3, take_buy_when_short_edge=1, quote_size_bid=6, quote_size_ask=14, tier_high=0.6, tier_extreme=0.85, bid_mult_medium=0.25, bid_mult_high=0.5, flatten_trigger=0.8, flatten_size=16, flatten_aggression=1
