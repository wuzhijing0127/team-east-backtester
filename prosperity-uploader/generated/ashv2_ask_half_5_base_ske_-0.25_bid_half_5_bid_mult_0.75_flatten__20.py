...
# Config: micro_beta=0.1, base_skew=-0.25, inventory_skew_k=4.0, bid_half_spread=5, ask_half_spread=5, join_improve_mode=1, take_buy_edge=4, take_sell_edge=3, take_buy_when_short_edge=2, take_sell_when_long_edge=1, quote_size_bid=16, quote_size_ask=4, tier_high=0.8, tier_extreme=1.0, bid_mult_medium=0.75, flatten_trigger=0.75, flatten_size=20
