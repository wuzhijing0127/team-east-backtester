...
# Config: micro_beta=0.2, imbalance_beta=0.3, base_skew=-0.25, inventory_skew_k=2.0, bid_half_spread=6, ask_half_spread=4, take_buy_edge=3, take_sell_edge=4, take_sell_when_long_edge=3, quote_size_bid=12, quote_size_ask=8, tier_high=0.5, tier_extreme=0.85, bid_mult_medium=0.25, ask_mult_medium=0.0, ask_mult_high=0.5, flatten_trigger=0.95, flatten_size=14
