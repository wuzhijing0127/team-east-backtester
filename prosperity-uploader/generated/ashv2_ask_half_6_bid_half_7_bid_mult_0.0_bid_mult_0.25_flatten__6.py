...
# Config: imbalance_beta=0.3, inventory_skew_k=1.5, bid_half_spread=7, ask_half_spread=6, join_improve_mode=1, take_buy_edge=1, take_buy_when_short_edge=1, take_sell_when_long_edge=2, quote_size_bid=4, quote_size_ask=10, tier_medium=0.5, tier_high=0.5, tier_extreme=0.95, bid_mult_medium=0.25, bid_mult_high=0.0, flatten_size=6
