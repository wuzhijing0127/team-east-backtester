...
# Config: micro_beta=0.2, imbalance_beta=0.4, inventory_skew_k=1.5, bid_half_spread=6, ask_half_spread=6, take_buy_edge=1, take_sell_edge=3, take_buy_when_short_edge=2, take_sell_when_long_edge=2, quote_size_bid=10, quote_size_ask=24, tier_medium=0.6, tier_extreme=0.95, bid_mult_medium=1.0, bid_mult_high=0.0, ask_mult_high=0.0, flatten_trigger=0.95, flatten_size=14, flatten_aggression=1
