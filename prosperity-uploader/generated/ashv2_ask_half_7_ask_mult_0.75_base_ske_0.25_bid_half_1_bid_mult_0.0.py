...
# Config: micro_beta=0.2, base_skew=0.25, inventory_skew_k=1.0, bid_half_spread=1, ask_half_spread=7, take_buy_edge=3, take_sell_edge=3, take_buy_when_short_edge=2, take_sell_when_long_edge=3, quote_size_bid=22, quote_size_ask=12, tier_medium=0.3, tier_extreme=0.85, bid_mult_medium=0.0, ask_mult_medium=0.75, flatten_trigger=0.8, flatten_size=4
