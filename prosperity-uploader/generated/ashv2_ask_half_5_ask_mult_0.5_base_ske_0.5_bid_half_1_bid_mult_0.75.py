...
# Config: micro_beta=0.2, imbalance_beta=0.4, base_skew=0.5, inventory_skew_k=3.0, bid_half_spread=1, ask_half_spread=5, join_improve_mode=1, take_buy_edge=4, take_sell_edge=0, take_sell_when_long_edge=2, quote_size_bid=6, quote_size_ask=22, tier_medium=0.6, tier_high=0.6, bid_mult_medium=0.75, ask_mult_high=0.5, flatten_trigger=1.0, flatten_size=12, flatten_aggression=1
