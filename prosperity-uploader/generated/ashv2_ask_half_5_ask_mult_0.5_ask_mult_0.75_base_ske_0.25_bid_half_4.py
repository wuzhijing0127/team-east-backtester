...
# Config: micro_beta=0.1, imbalance_beta=0.4, base_skew=0.25, inventory_skew_k=3.0, bid_half_spread=4, ask_half_spread=5, join_improve_mode=1, take_buy_edge=0, take_sell_edge=1, take_buy_when_short_edge=1, take_sell_when_long_edge=2, quote_size_bid=18, quote_size_ask=12, tier_high=0.5, ask_mult_medium=0.75, bid_mult_high=0.0, ask_mult_high=0.5, flatten_trigger=0.75, flatten_size=18
