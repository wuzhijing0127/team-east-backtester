...
# Config: micro_beta=0.1, imbalance_beta=0.1, inventory_skew_k=1.5, bid_half_spread=1, ask_half_spread=2, join_improve_mode=0, take_buy_edge=1, take_buy_when_short_edge=3, take_sell_when_long_edge=2, quote_size_bid=18, quote_size_ask=4, tier_medium=0.5, tier_high=0.8, tier_extreme=0.95, ask_mult_medium=0.75, bid_mult_high=0.0, flatten_trigger=1.0, flatten_size=20
