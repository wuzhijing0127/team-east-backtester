...
# Config: micro_beta=0.2, imbalance_beta=0.3, base_skew=0.5, bid_half_spread=5, ask_half_spread=5, join_improve_mode=1, take_buy_edge=1, quote_size_bid=16, quote_size_ask=20, tier_high=0.8, tier_extreme=1.0, bid_mult_medium=0.0, ask_mult_medium=0.25, bid_mult_high=0.5, flatten_size=8
