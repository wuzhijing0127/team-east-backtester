...
# Config: micro_beta=0.3, imbalance_beta=0.3, inventory_skew_k=1.0, bid_half_spread=5, ask_half_spread=4, join_improve_mode=1, take_sell_edge=1, take_buy_when_short_edge=1, take_sell_when_long_edge=1, quote_size_bid=10, quote_size_ask=14, tier_medium=0.5, tier_extreme=0.85, bid_mult_medium=0.75, ask_mult_medium=0.0, flatten_size=4
