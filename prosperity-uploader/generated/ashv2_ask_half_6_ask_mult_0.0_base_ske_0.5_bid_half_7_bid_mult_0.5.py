...
# Config: micro_beta=0.2, imbalance_beta=0.2, base_skew=0.5, bid_half_spread=7, ask_half_spread=6, take_buy_edge=4, take_sell_edge=3, take_buy_when_short_edge=1, take_sell_when_long_edge=3, quote_size_bid=18, quote_size_ask=22, tier_medium=0.3, tier_high=0.8, bid_mult_medium=0.25, bid_mult_high=0.5, ask_mult_high=0.0, flatten_trigger=0.85, flatten_size=6, flatten_aggression=1
