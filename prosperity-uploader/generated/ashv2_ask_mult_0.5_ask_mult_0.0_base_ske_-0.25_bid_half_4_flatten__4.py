...
# Config: micro_beta=0.5, imbalance_beta=0.3, base_skew=-0.25, inventory_skew_k=3.0, bid_half_spread=4, take_sell_edge=1, take_buy_when_short_edge=2, take_sell_when_long_edge=1, quote_size_bid=4, quote_size_ask=24, tier_extreme=0.8, ask_mult_medium=0.0, ask_mult_high=0.5, flatten_trigger=0.85, flatten_size=4
