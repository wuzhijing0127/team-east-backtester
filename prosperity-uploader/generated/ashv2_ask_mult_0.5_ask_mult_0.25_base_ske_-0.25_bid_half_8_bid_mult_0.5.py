...
# Config: micro_beta=0.3, imbalance_beta=0.1, base_skew=-0.25, inventory_skew_k=4.0, bid_half_spread=8, join_improve_mode=0, take_buy_edge=3, take_sell_edge=0, quote_size_bid=4, quote_size_ask=24, tier_medium=0.3, tier_extreme=0.8, bid_mult_medium=0.0, ask_mult_medium=0.25, bid_mult_high=0.5, ask_mult_high=0.5, flatten_trigger=0.7, flatten_size=8
