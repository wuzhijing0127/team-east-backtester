...
# Config: micro_beta=0.3, imbalance_beta=0.4, inventory_skew_k=3.5, bid_half_spread=7, take_buy_edge=3, take_sell_edge=3, take_sell_when_long_edge=2, quote_size_bid=6, quote_size_ask=20, tier_high=0.6, tier_extreme=0.85, bid_mult_medium=0.25, bid_mult_high=0.5, ask_mult_high=0.0, flatten_trigger=0.8, flatten_size=14, flatten_aggression=1
