...
# Config: micro_beta=0.5, imbalance_beta=0.4, base_skew=-0.5, inventory_skew_k=1.0, bid_half_spread=8, ask_half_spread=4, take_buy_edge=0, take_buy_when_short_edge=2, take_sell_when_long_edge=3, quote_size_bid=22, quote_size_ask=22, tier_high=0.6, tier_extreme=0.85, bid_mult_medium=0.0, ask_mult_medium=0.75, bid_mult_high=0.5, flatten_size=18, flatten_aggression=1
