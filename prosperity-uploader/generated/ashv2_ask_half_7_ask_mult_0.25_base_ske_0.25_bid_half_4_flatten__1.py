...
# Config: micro_beta=0.1, imbalance_beta=0.5, base_skew=0.25, inventory_skew_k=3.5, bid_half_spread=4, ask_half_spread=7, join_improve_mode=0, take_buy_edge=0, take_sell_edge=0, take_buy_when_short_edge=2, take_sell_when_long_edge=3, quote_size_bid=20, quote_size_ask=22, tier_medium=0.5, ask_mult_medium=0.25, flatten_size=14, flatten_aggression=1
