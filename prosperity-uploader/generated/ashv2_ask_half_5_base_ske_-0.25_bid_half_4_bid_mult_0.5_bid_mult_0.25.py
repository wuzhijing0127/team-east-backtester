...
# Config: micro_beta=0.4, imbalance_beta=0.2, base_skew=-0.25, inventory_skew_k=1.5, bid_half_spread=4, ask_half_spread=5, join_improve_mode=0, take_buy_edge=0, take_sell_edge=3, take_buy_when_short_edge=3, take_sell_when_long_edge=2, quote_size_bid=24, quote_size_ask=24, tier_high=0.8, bid_mult_medium=0.25, bid_mult_high=0.5, flatten_trigger=0.85, flatten_size=4, flatten_aggression=1
