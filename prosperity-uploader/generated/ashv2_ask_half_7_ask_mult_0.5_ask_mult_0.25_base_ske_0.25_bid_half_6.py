...
# Config: imbalance_beta=0.1, base_skew=0.25, bid_half_spread=6, ask_half_spread=7, join_improve_mode=0, take_buy_edge=3, take_buy_when_short_edge=2, take_sell_when_long_edge=2, quote_size_bid=4, quote_size_ask=24, tier_high=0.6, tier_extreme=1.0, bid_mult_medium=0.25, ask_mult_medium=0.25, bid_mult_high=0.5, ask_mult_high=0.5, flatten_trigger=1.0, flatten_size=18
