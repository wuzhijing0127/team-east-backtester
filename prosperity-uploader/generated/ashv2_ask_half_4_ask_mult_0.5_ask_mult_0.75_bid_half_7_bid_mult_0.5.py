...
# Config: micro_beta=0.4, imbalance_beta=0.3, bid_half_spread=7, ask_half_spread=4, join_improve_mode=1, take_buy_edge=4, take_sell_edge=3, take_buy_when_short_edge=1, take_sell_when_long_edge=2, quote_size_bid=8, quote_size_ask=24, tier_medium=0.3, tier_high=0.6, tier_extreme=0.85, ask_mult_medium=0.75, bid_mult_high=0.5, ask_mult_high=0.5, flatten_trigger=0.7, flatten_size=16
