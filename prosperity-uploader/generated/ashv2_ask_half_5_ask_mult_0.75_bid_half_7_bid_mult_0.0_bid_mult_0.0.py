...
# Config: micro_beta=0.5, imbalance_beta=0.2, bid_half_spread=7, ask_half_spread=5, join_improve_mode=0, take_buy_edge=3, take_sell_edge=4, quote_size_bid=18, quote_size_ask=14, tier_high=0.5, tier_extreme=0.95, bid_mult_medium=0.0, ask_mult_medium=0.75, bid_mult_high=0.0, flatten_trigger=0.8, flatten_size=18, flatten_aggression=1
