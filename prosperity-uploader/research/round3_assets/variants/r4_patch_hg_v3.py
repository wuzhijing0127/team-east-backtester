...
# ── PARAMS_BLOCK_START ──
VARIANT_ID = 'patch_hg_v3'
VARIANT_LABEL = 'HG patch: alpha_scale 25→60, size_step 20→5, take_trigger 35→15, quote_size 20→25'
...
HG_PARAMS = {
    ...
    'k_inv_floor': 0.25,
    'one_sided_trigger': 40,
    'opposite_min_size': 5,
    'chop_threshold': 1.5,
    'chop_target_cap_scale': 0.5,
    'chop_take_scale': 0.6,
...
# nonce: 2026-04-26T18:21:55.732739 689002058
