...
# ── PARAMS_BLOCK_START ──
VARIANT_ID = 'force_big_pos'
VARIANT_LABEL = 'AGGRESSIVE: take_edge low, alpha_scale 70/160, target_cap 200, k_inv_floor 0.10'
...
HG_PARAMS = {
    ...
    'take_trigger': 10,
    'conviction_norm': 2.0,
    'conviction_relief': 0.9,
    'k_inv_floor': 0.1,
    'one_sided_trigger': 30,
    'opposite_min_size': 5,
    'chop_threshold': 0.8,
    'chop_target_cap_scale': 0.6,
    'chop_take_scale': 0.7,
    'chop_relief_scale': 0.5,
    'diag_print_every': 100,
    ...
    'stop_drawdown_threshold': 6000.0,
...
# nonce: 2026-04-26T18:19:03.747106 79267923
