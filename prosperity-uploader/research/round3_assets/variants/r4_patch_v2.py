...
# ── PARAMS_BLOCK_START ──
VARIANT_ID = 'patch_v2'
VARIANT_LABEL = 'patch v2: HG take=30/big=80, VFE one_sided ON (trigger=20, opp=3), chop scales softer'
...
HG_PARAMS = {
    ...
    'take_trigger': 35,
    'conviction_norm': 4.0,
    'conviction_relief': 0.6,
    'k_inv_floor': 0.25,
    'one_sided_trigger': 20,
    'opposite_min_size': 0,
    'chop_threshold': 1.5,
    'chop_target_cap_scale': 0.8,
    'chop_take_scale': 0.85,
    'chop_relief_scale': 0.0,
...
# nonce: 2026-04-26T18:13:17.375117 336390872
