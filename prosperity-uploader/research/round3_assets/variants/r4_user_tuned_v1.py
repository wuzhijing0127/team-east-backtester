...
# ── PARAMS_BLOCK_START ──
VARIANT_ID = 'user_tuned_v1'
VARIANT_LABEL = 'User-tuned: HG(trend=0.3, micro_trend=0.1) VFE(trend=0.15, revert=0.2, vel=0.2, deep_imb=0.1)'
...
# nonce: 2026-04-26T15:57:40.614166 149215251
